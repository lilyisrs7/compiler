...
ble.33452:
	...
	sw		x4, 0(x2)	# 1317
	sw		x5, -4(x2)	# 1317
	beq		x11, x21, beq.33455	# 1317
	beq		x11, x22, beq.33457	# 1319
	fadd	f1, f0, f0	# 11
	addi	x11, x0, 5	# 98
	fsw		f0, -8(x2)	# 1283
	addi	x4, x11, 0	# 1283
...
ble.33496:
	...
	addi	x10, x8, 8	# 1343
	fsw		f1, 0(x10)	# 1343
	beq		x9, x22, beq.33499	# 1344
	ble		x9, x22, beq_cont.33498	# 1347
	flw		f1, 0(x11)	# 1348
	flw		f2, 0(x12)	# 1348
	flw		f3, 0(x10)	# 1348
	fmul	f4, f1, f1	# 127
...
check_all_inside.2886.17901:
	...
	fsub	f6, f3, f6	# 1394
	lw		x7, 4(x6)	# 395
	beq		x7, x21, beq.33508	# 1396
	beq		x7, x22, beq.33510	# 1398
	fmul	f7, f4, f4	# 127
	lw		x9, 16(x6)	# 433
	addi	x10, x9, 0	# 438
	flw		f8, 0(x10)	# 438
...
shadow_check_and_group.2892.17907:
	...
	lw		x6, 0(x6)	# 1173
	lw		x9, 4(x7)	# 395
	beq		x9, x21, beq.33550	# 1175
	beq		x9, x22, beq.33552	# 1177
	addi	x10, x6, 0	# 1149
	flw		f7, 0(x10)	# 1149
...
shadow_check_one_or_matrix.2898.17913:
	...
	addi	x8, x6, 0	# 1472
	lw		x8, 0(x8)	# 1472
	beq		x8, x20, beq.33610	# 1473
	sw		x6, 0(x2)	# 1477
	sw		x5, -4(x2)	# 1477
	sw		x4, -8(x2)	# 1477
	sw		x0, -12(x2)	# 1477
	beq		x8, x28, beq.33612	# 1477
	mul		x8, x30, x8	# 1168
	...
	lw		x8, 0(x8)	# 1173
	lw		x10, 4(x9)	# 395
	beq		x10, x21, beq.33614	# 1175
	beq		x10, x22, beq.33616	# 1177
	addi	x12, x8, 0	# 1149
	flw		f4, 0(x12)	# 1149
...
solve_each_element.2901.17916:
	...
	fsub	f6, f5, f6	# 1078
	lw		x10, 4(x8)	# 395
	beq		x10, x21, beq.33675	# 1081
	beq		x10, x22, beq.33677	# 1082
	addi	x11, x6, 0	# 1048
	flw		f7, 0(x11)	# 1048
	addi	x11, x6, 4	# 1048
	flw		f8, 0(x11)	# 1048
...
trace_or_matrix.2909.17924:
	...
	addi	x9, x7, 0	# 1559
	lw		x9, 0(x9)	# 1559
	beq		x9, x20, beq.33766	# 1560
	sw		x6, 0(x2)	# 1563
	sw		x5, -4(x2)	# 1563
	sw		x4, -8(x2)	# 1563
	beq		x9, x28, beq.33768	# 1563
	mul		x9, x30, x9	# 1074
	...
	fsub	f3, f3, f4	# 1078
	lw		x10, 4(x9)	# 395
	beq		x10, x21, beq.33770	# 1081
	beq		x10, x22, beq.33772	# 1082
	addi	x12, x6, 0	# 1048
	flw		f4, 0(x12)	# 1048
	addi	x12, x6, 4	# 1048
	flw		f5, 0(x12)	# 1048
...
solve_each_element_fast.2915.17928:
	...
	lw		x10, 0(x10)	# 1221
	lw		x17, 4(x11)	# 395
	beq		x17, x21, beq.33856	# 1223
	beq		x17, x22, beq.33858	# 1225
	addi	x17, x10, 0	# 1197
	flw		f4, 0(x17)	# 1197
...
fle_cont.33904:
	...
	lw		x7, 0(x7)	# 1221
	lw		x10, 4(x8)	# 395
	beq		x10, x21, beq.33912	# 1223
	beq		x10, x22, beq.33914	# 1225
	addi	x10, x7, 0	# 1197
	flw		f4, 0(x10)	# 1197
	flw		f5, -8(x2)	# 120
...
beq.33903:
	...
	lw		x9, 0(x9)	# 1221
	lw		x12, 4(x10)	# 395
	beq		x12, x21, beq.33972	# 1223
	beq		x12, x22, beq.33974	# 1225
	addi	x12, x9, 0	# 1197
	flw		f4, 0(x12)	# 1197
...
solve_one_or_network_fast.2919.17932:
	...
	sw		x5, -12(x2)	# 1602
	sw		x4, -16(x2)	# 1602
	beq		x11, x20, beq_cont.34032	# 1602
	...
	lw		x12, 0(x12)	# 1221
	lw		x17, 4(x13)	# 395
	beq		x17, x21, beq.34035	# 1223
	beq		x17, x22, beq.34037	# 1225
	addi	x16, x12, 0	# 1197
	flw		f4, 0(x16)	# 1197
...
trace_or_matrix_fast.2923.17936:
	...
	addi	x9, x7, 0	# 1652
	lw		x9, 0(x9)	# 1652
	beq		x9, x20, beq.34095	# 1653
	sw		x6, 0(x2)	# 1656
	sw		x5, -4(x2)	# 1656
	sw		x4, -8(x2)	# 1656
	beq		x9, x28, beq.34097	# 1656
	mul		x9, x30, x9	# 1215
	...
	lw		x9, 0(x9)	# 1221
	lw		x15, 4(x11)	# 395
	beq		x15, x21, beq.34099	# 1223
	beq		x15, x22, beq.34101	# 1225
	addi	x13, x9, 0	# 1197
	flw		f4, 0(x13)	# 1197
...
beq_cont.34098:
	...
	addi	x9, x7, 4	# 1641
	lw		x9, 0(x9)	# 1641
	beq		x9, x20, beq_cont.34096	# 1642
	mul		x9, x30, x9	# 1643
...
fle_cont.34173:
	...
	fmul	f4, f2, f3	# 1881
	lw		x9, 4(x6)	# 395
	beq		x9, x21, beq.34179	# 1735
	beq		x9, x22, beq.34181	# 1737
	flw		f5, 0(x25)	# 1712
	lw		x9, 20(x6)	# 473
	addi	x11, x9, 0	# 478
	flw		f6, 0(x11)	# 478
...
beq_cont.34178:
	...
	fsw		f5, -56(x2)	# 1755
	sw		x4, -60(x2)	# 1755
	beq		x12, x21, beq.34193	# 1755
	beq		x12, x22, beq.34195	# 1773
	beq		x12, x24, beq.34197	# 1780
	lw		x16, -12(x2)	# 1791
...
fle_cont.34208:
	...
	fadd	f1, f0, f0	# 1816
fle_cont.34212:
	lui		x4, %hi(l.29478)	# 25
	ori		x4, x0, %lo(l.29478)	# 25
	flw		f2, 0(x4)	# 25
	fmul	f1, f2, f1	# 1817
...
beq.34193:
	...
	fsub	f1, f10, f1	# 1766
	flw		f2, -88(x2)	# 125
	fle		f28, f2, fle.34215	# 125
	fle		f28, f1, fle.34217	# 125
	lui		x4, %hi(l.29478)	# 25
	ori		x4, x0, %lo(l.29478)	# 25
	flw		f1, 0(x4)	# 25
...
beq.34264:
	...
	fsub	f1, f4, f1	# 1766
	flw		f2, -96(x2)	# 125
	fle		f28, f2, fle.34286	# 125
	fle		f28, f1, fle.34288	# 125
	lui		x4, %hi(l.29478)	# 25
	ori		x4, x0, %lo(l.29478)	# 25
	flw		f1, 0(x4)	# 25
...
beq.34316:
	...
	fsub	f1, f4, f1	# 1766
	flw		f2, -172(x2)	# 125
	fle		f28, f2, fle.34338	# 125
	fle		f28, f1, fle.34340	# 125
	lui		x4, %hi(l.29478)	# 25
	ori		x4, x0, %lo(l.29478)	# 25
	flw		f1, 0(x4)	# 25
...
beq_cont.34357:
	lw		x5, -48(x2)	# 2025
	beq		x5, x24, beq_cont.34359	# 2025
