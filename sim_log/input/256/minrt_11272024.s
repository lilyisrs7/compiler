...
fle.10214:
	fle		x31, f3, f0	# 47
	addi	x31, x31, -1	# 47
	beq		x31, x0, fle.10215	# 47
	fle		x31, f4, f0	# 48
	addi	x31, x31, -1	# 48
	beq		x31, x0, fle.10216	# 48
	fle		x31, f0, f2	# 49
	addi	x31, x31, -1	# 49
	beq		x31, x0, fle.10217	# 49
	fsub	f0, f4, f0	# 49
	lw		x31, 0(x27)	# 49
	jalr	x0, x31, 0	# 49
fle.10217:
...
vecunit_sgn.2565:
	...
	lui		x5, 0	# 284
	ori		x5, x0, 0	# 284
	beq		x4, x5, beq.10233	# 284
	lui		x4, %hi(l.6125)	# 284
	ori		x4, x0, %lo(l.6125)	# 284
	flw		f0, 0(x4)	# 284
	jal		x0, beq_cont.10234	# 284
beq.10233:
	lui		x4, 0	# 284
	ori		x4, x0, 0	# 284
	lw		x5, 0(x2)	# 284
	beq		x5, x4, beq.10235	# 284
	lui		x4, %hi(l.6165)	# 284
	ori		x4, x0, %lo(l.6165)	# 284
	flw		f0, 0(x4)	# 284
	flw		f1, -24(x2)	# 284
	fdiv	f0, f0, f1	# 284
	jal		x0, beq_cont.10236	# 284
beq.10235:
	lui		x4, %hi(l.6125)	# 284
	ori		x4, x0, %lo(l.6125)	# 284
	flw		f0, 0(x4)	# 284
...
read_nth_object.2670:
	...
	add		x4, x5, x4	# 812
	fsw		f0, 0(x4)	# 812
	jal		x0, beq_cont.10252	# 808
beq.10251:
beq_cont.10252:
	lui		x4, 2	# 819
	ori		x4, x0, 2	# 819
	lw		x5, -16(x2)	# 819
	beq		x5, x4, beq.10253	# 819
	lw		x4, -60(x2)	# 819
	jal		x0, beq_cont.10254	# 819
beq.10253:
	lui		x4, 1	# 819
	ori		x4, x0, 1	# 819
beq_cont.10254:
	...
	lui		x5, 3	# 833
	ori		x5, x0, 3	# 833
	beq		x8, x5, beq.10255	# 833
	lui		x5, 2	# 843
	ori		x5, x0, 2	# 843
	beq		x8, x5, beq.10257	# 843
	jal		x0, beq_cont.10258	# 843
beq.10257:
	lui		x5, 0	# 845
	ori		x5, x0, 0	# 845
	lw		x8, -60(x2)	# 845
	beq		x8, x5, beq.10259	# 845
	lui		x5, 0	# 845
	ori		x5, x0, 0	# 845
	jal		x0, beq_cont.10260	# 845
beq.10259:
	lui		x5, 1	# 845
	ori		x5, x0, 1	# 845
beq_cont.10260:
...
beq.10255:
	...
	lui		x5, 0	# 837
	ori		x5, x0, 0	# 837
	beq		x4, x5, beq.10262	# 837
	lui		x4, %hi(l.6117)	# 837
	ori		x4, x0, %lo(l.6117)	# 837
	flw		f0, 0(x4)	# 837
	jal		x0, beq_cont.10263	# 837
beq.10262:
	flw		f0, -120(x2)	# 837
	sw		x1, -128(x2)	# 837
	addi	x2, x2, -132	# 837
...
beq_cont.10263:
	...
	lui		x5, 0	# 839
	ori		x5, x0, 0	# 839
	beq		x4, x5, beq.10265	# 839
	lui		x4, %hi(l.6117)	# 839
	ori		x4, x0, %lo(l.6117)	# 839
	flw		f0, 0(x4)	# 839
	jal		x0, beq_cont.10266	# 839
beq.10265:
	flw		f0, -144(x2)	# 839
	sw		x1, -152(x2)	# 839
	addi	x2, x2, -156	# 839
...
beq_cont.10266:
	...
	lui		x5, 0	# 841
	ori		x5, x0, 0	# 841
	beq		x4, x5, beq.10268	# 841
	lui		x4, %hi(l.6117)	# 841
	ori		x4, x0, %lo(l.6117)	# 841
	flw		f0, 0(x4)	# 841
	jal		x0, beq_cont.10269	# 841
beq.10268:
	flw		f0, -168(x2)	# 841
	sw		x1, -176(x2)	# 841
	addi	x2, x2, -180	# 841
...
beq.10298:
	...
	lui		x5, 3	# 1016
	ori		x5, x0, 3	# 1016
	beq		x4, x5, beq.10299	# 1016
	flw		f0, -56(x2)	# 1016
	jal		x0, beq_cont.10300	# 1016
beq.10299:
...
beq_cont.10300:
	...
	lui		x5, 0	# 1022
	ori		x5, x0, 0	# 1022
	beq		x4, x5, beq.10302	# 1022
	flw		f0, -80(x2)	# 1022
	jal		x0, beq_cont.10303	# 1022
beq.10302:
	flw		f0, -80(x2)	# 1022
	sw		x1, -88(x2)	# 1022
	addi	x2, x2, -92	# 1022
...
solver_rect_fast.2728:
	...
	lui		x5, 0	# 1068
	ori		x5, x0, 0	# 1068
	beq		x4, x5, beq.10312	# 1068
	lui		x4, 0	# 1068
	ori		x4, x0, 0	# 1068
	jal		x0, beq_cont.10313	# 1068
beq.10312:
	lui		x4, 1	# 1068
	ori		x4, x0, 1	# 1068
beq_cont.10313:
	jal		x0, beq_cont.10311	# 1067
beq.10310:
	lui		x4, 0	# 1069
	ori		x4, x0, 0	# 1069
beq_cont.10311:
	jal		x0, beq_cont.10309	# 1066
beq.10308:
	lui		x4, 0	# 1070
	ori		x4, x0, 0	# 1070
beq_cont.10309:
...
beq.10314:
	...
	lui		x5, 0	# 1077
	ori		x5, x0, 0	# 1077
	beq		x4, x5, beq.10319	# 1077
	lui		x4, 0	# 1077
	ori		x4, x0, 0	# 1077
	jal		x0, beq_cont.10320	# 1077
beq.10319:
	lui		x4, 1	# 1077
	ori		x4, x0, 1	# 1077
beq_cont.10320:
	jal		x0, beq_cont.10318	# 1076
beq.10317:
	lui		x4, 0	# 1078
	ori		x4, x0, 0	# 1078
beq_cont.10318:
	jal		x0, beq_cont.10316	# 1075
beq.10315:
	lui		x4, 0	# 1079
	ori		x4, x0, 0	# 1079
beq_cont.10316:
...
beq.10321:
	...
	lui		x5, 0	# 1086
	ori		x5, x0, 0	# 1086
	beq		x4, x5, beq.10326	# 1086
	lui		x4, 0	# 1086
	ori		x4, x0, 0	# 1086
	jal		x0, beq_cont.10327	# 1086
beq.10326:
	lui		x4, 1	# 1086
	ori		x4, x0, 1	# 1086
beq_cont.10327:
	jal		x0, beq_cont.10325	# 1085
beq.10324:
	lui		x4, 0	# 1087
	ori		x4, x0, 0	# 1087
beq_cont.10325:
	jal		x0, beq_cont.10323	# 1084
beq.10322:
	lui		x4, 0	# 1088
	ori		x4, x0, 0	# 1088
beq_cont.10323:
...
beq.10333:
	...
	lui		x5, 3	# 1113
	ori		x5, x0, 3	# 1113
	beq		x4, x5, beq.10335	# 1113
	flw		f0, -64(x2)	# 1113
	jal		x0, beq_cont.10336	# 1113
beq.10335:
...
beq_cont.10364:
	...
	lui		x5, 0	# 1261
	ori		x5, x0, 0	# 1261
	beq		x4, x5, beq.10368	# 1261
	jal		x0, beq_cont.10369	# 1261
beq.10368:
	lui		x4, 4	# 1262
	ori		x4, x0, 4	# 1262
...
ble.10370:
	...
	lui		x5, 1	# 1275
	ori		x5, x0, 1	# 1275
	beq		x4, x5, beq.10372	# 1275
	lui		x5, 2	# 1277
	ori		x5, x0, 2	# 1277
	beq		x4, x5, beq.10374	# 1277
	lw		x4, -20(x2)	# 1280
	lw		x5, -8(x2)	# 1280
	sw		x1, -24(x2)	# 1280
	addi	x2, x2, -28	# 1280
...
ble.10376:
	...
	ori		x4, x0, 2	# 1302
	lw		x6, -20(x2)	# 1302
	beq		x6, x4, beq.10381	# 1302
	lui		x4, 2	# 1305
	ori		x4, x0, 2	# 1305
	ble		x6, x4, ble.10383	# 1305
	lui		x4, 0	# 1306
	ori		x4, x0, 0	# 1306
	lui		x7, 4	# 1306
	ori		x7, x0, 4	# 1306
	...
	ori		x5, x0, 3	# 1307
	lw		x6, -20(x2)	# 1307
	beq		x6, x5, beq.10385	# 1307
	jal		x0, beq_cont.10386	# 1307
beq.10385:
...
beq_cont.10386:
	...
	add		x4, x5, x4	# 1307
	fsw		f0, 0(x4)	# 1307
	jal		x0, ble_cont.10384	# 1305
ble.10383:
ble_cont.10384:
	jal		x0, beq_cont.10382	# 1302
beq.10381:
	lui		x4, 3	# 1303
	ori		x4, x0, 3	# 1303
	lw		x6, -12(x2)	# 1304
...
is_rect_outside.2787:
	...
	addi	x2, x2, 52	# 1329
	lw		x1, -48(x2)	# 1329
	jal		x0, beq_cont.10391	# 1328
beq.10390:
	lui		x4, 0	# 1330
	ori		x4, x0, 0	# 1330
beq_cont.10391:
	jal		x0, beq_cont.10389	# 1327
beq.10388:
	lui		x4, 0	# 1331
	ori		x4, x0, 0	# 1331
beq_cont.10389:
...
is_second_outside.2797:
	...
	lui		x5, 3	# 1344
	ori		x5, x0, 3	# 1344
	beq		x4, x5, beq.10397	# 1344
	flw		f0, -8(x2)	# 1344
	jal		x0, beq_cont.10398	# 1344
beq.10397:
...
shadow_check_one_or_matrix.2819:
	...
	lui		x5, 0	# 1443
	ori		x5, x0, 0	# 1443
	beq		x4, x5, beq.10421	# 1443
	lui		x4, 1	# 1444
	ori		x4, x0, 1	# 1444
	jal		x0, beq_cont.10422	# 1443
beq.10421:
	lui		x4, 0	# 1445
	ori		x4, x0, 0	# 1445
beq_cont.10422:
	jal		x0, beq_cont.10420	# 1442
beq.10419:
	lui		x4, 0	# 1446
	ori		x4, x0, 0	# 1446
beq_cont.10420:
	jal		x0, beq_cont.10418	# 1441
beq.10417:
	lui		x4, 0	# 1447
	ori		x4, x0, 0	# 1447
beq_cont.10418:
	jal		x0, beq_cont.10416	# 1435
beq.10415:
	lui		x4, 1	# 1436
	ori		x4, x0, 1	# 1436
beq_cont.10416:
...
solve_each_element.2822:
	...
	lw		x5, -52(x2)	# 1487
	sw		x5, 0(x4)	# 1487
	jal		x0, beq_cont.10432	# 1482
beq.10431:
beq_cont.10432:
	jal		x0, beq_cont.10430	# 1476
beq.10429:
beq_cont.10430:
	jal		x0, beq_cont.10428	# 1475
beq.10427:
beq_cont.10428:
	lw		x4, -40(x2)	# 1493
	addi	x4, x4, 1	# 1493
...
trace_or_matrix.2830:
	...
	addi	x2, x2, 36	# 1530
	lw		x1, -32(x2)	# 1530
	jal		x0, beq_cont.10444	# 1529
beq.10443:
beq_cont.10444:
	jal		x0, beq_cont.10442	# 1527
beq.10441:
beq_cont.10442:
	jal		x0, beq_cont.10440	# 1521
beq.10439:
	lui		x7, 1	# 1522
	ori		x7, x0, 1	# 1522
	addi	x5, x12, 0
...
solve_each_element_fast.2836:
	...
	lw		x5, -60(x2)	# 1581
	sw		x5, 0(x4)	# 1581
	jal		x0, beq_cont.10455	# 1576
beq.10454:
beq_cont.10455:
	jal		x0, beq_cont.10453	# 1570
beq.10452:
beq_cont.10453:
	jal		x0, beq_cont.10451	# 1569
beq.10450:
beq_cont.10451:
	lw		x4, -48(x2)	# 1587
	addi	x4, x4, 1	# 1587
...
trace_or_matrix_fast.2844:
	...
	addi	x2, x2, 36	# 1623
	lw		x1, -32(x2)	# 1623
	jal		x0, beq_cont.10467	# 1622
beq.10466:
beq_cont.10467:
	jal		x0, beq_cont.10465	# 1620
beq.10464:
beq_cont.10465:
	jal		x0, beq_cont.10463	# 1614
beq.10462:
	lui		x7, 1	# 1615
	ori		x7, x0, 1	# 1615
	addi	x5, x11, 0
...
beq.10484:
	...
	lui		x5, 0	# 1755
	ori		x5, x0, 0	# 1755
	beq		x4, x5, beq.10486	# 1755
	lui		x4, %hi(l.7359)	# 1756
	ori		x4, x0, %lo(l.7359)	# 1756
	flw		f0, 0(x4)	# 1756
	jal		x0, beq_cont.10487	# 1755
beq.10486:
	flw		f0, -56(x2)	# 1758
	flw		f1, -80(x2)	# 1758
	fdiv	f0, f1, f0	# 1758
...
beq_cont.10487:
	...
	lui		x5, 0	# 1766
	ori		x5, x0, 0	# 1766
	beq		x4, x5, beq.10488	# 1766
	lui		x4, %hi(l.7359)	# 1767
	ori		x4, x0, %lo(l.7359)	# 1767
	flw		f0, 0(x4)	# 1767
	jal		x0, beq_cont.10489	# 1766
beq.10488:
	flw		f0, -96(x2)	# 1769
	flw		f1, -136(x2)	# 1769
	fdiv	f0, f1, f0	# 1769
...
beq_cont.10489:
	...
	lui		x5, 0	# 1774
	ori		x5, x0, 0	# 1774
	beq		x4, x5, beq.10490	# 1774
	lui		x4, %hi(l.6117)	# 1774
	ori		x4, x0, %lo(l.6117)	# 1774
	flw		f0, 0(x4)	# 1774
	jal		x0, beq_cont.10491	# 1774
beq.10490:
	flw		f0, -176(x2)	# 1774
beq_cont.10491:
	lui		x4, 2	# 1775
...
beq.10481:
	...
	ori		x6, x0, 0	# 1727
	lw		x7, -248(x2)	# 1727
	beq		x7, x6, beq.10496	# 1727
	lui		x6, 0	# 1728
	ori		x6, x0, 0	# 1728
	beq		x4, x6, beq.10498	# 1728
	lui		x4, %hi(l.7377)	# 1728
	ori		x4, x0, %lo(l.7377)	# 1728
	flw		f0, 0(x4)	# 1728
	jal		x0, beq_cont.10499	# 1728
beq.10498:
	lui		x4, %hi(l.6117)	# 1728
	ori		x4, x0, %lo(l.6117)	# 1728
	flw		f0, 0(x4)	# 1728
beq_cont.10499:
	jal		x0, beq_cont.10497	# 1727
beq.10496:
	lui		x6, 0	# 1729
	ori		x6, x0, 0	# 1729
	beq		x4, x6, beq.10500	# 1729
	lui		x4, %hi(l.6117)	# 1729
	ori		x4, x0, %lo(l.6117)	# 1729
	flw		f0, 0(x4)	# 1729
	jal		x0, beq_cont.10501	# 1729
beq.10500:
...
ble.10508:
	...
	lw		x1, -68(x2)	# 1811
	lw		x5, -64(x2)	# 1811
	beq		x5, x4, beq.10512	# 1811
	jal		x0, beq_cont.10513	# 1811
beq.10512:
	lui		x4, 0	# 1813
	ori		x4, x0, 0	# 1813
	lui		x5, 0	# 1813
	...
	lui		x5, 0	# 1813
	ori		x5, x0, 0	# 1813
	beq		x4, x5, beq.10514	# 1813
	jal		x0, beq_cont.10515	# 1813
beq.10514:
	lw		x4, -60(x2)	# 1815
	sw		x1, -68(x2)	# 1815
	addi	x2, x2, -72	# 1815
...
beq_cont.10523:
	...
	lui		x5, 0	# 1870
	ori		x5, x0, 0	# 1870
	beq		x4, x5, beq.10524	# 1870
	jal		x0, beq_cont.10525	# 1870
beq.10524:
	lw		x4, -44(x2)	# 1871
	lw		x5, -104(x2)	# 1871
	sw		x1, -168(x2)	# 1871
...
beq.10538:
	...
	lui		x5, 0	# 1935
	ori		x5, x0, 0	# 1935
	beq		x4, x5, beq.10541	# 1935
	flw		f0, -64(x2)	# 1935
	jal		x0, beq_cont.10542	# 1935
beq.10541:
...
trace_diffuse_ray_80percent.2889:
	...
	addi	x2, x2, 24	# 1972
	lw		x1, -20(x2)	# 1972
	jal		x0, beq_cont.10549	# 1971
beq.10548:
beq_cont.10549:
	lui		x4, 1	# 1975
	ori		x4, x0, 1	# 1975
	lw		x5, -16(x2)	# 1975
	beq		x5, x4, beq.10550	# 1975
	lui		x4, 1	# 1976
	ori		x4, x0, 1	# 1976
	lui		x6, 4	# 1976
	ori		x6, x0, 4	# 1976
	...
	addi	x2, x2, 24	# 1976
	lw		x1, -20(x2)	# 1976
	jal		x0, beq_cont.10551	# 1975
beq.10550:
beq_cont.10551:
	lui		x4, 2	# 1979
	ori		x4, x0, 2	# 1979
	lw		x5, -16(x2)	# 1979
	beq		x5, x4, beq.10552	# 1979
	lui		x4, 2	# 1980
	ori		x4, x0, 2	# 1980
	lui		x6, 4	# 1980
	ori		x6, x0, 4	# 1980
	...
	addi	x2, x2, 24	# 1980
	lw		x1, -20(x2)	# 1980
	jal		x0, beq_cont.10553	# 1979
beq.10552:
beq_cont.10553:
	lui		x4, 3	# 1983
	ori		x4, x0, 3	# 1983
	lw		x5, -16(x2)	# 1983
	beq		x5, x4, beq.10554	# 1983
	lui		x4, 3	# 1984
	ori		x4, x0, 3	# 1984
	lui		x6, 4	# 1984
	ori		x6, x0, 4	# 1984
...
write_rgb_element_int.2927:
	...
	lui		x5, 255	# 2129
	ori		x5, x0, 255	# 2129
	ble		x4, x5, ble.10579	# 2129
	lui		x4, 255	# 2129
	ori		x4, x0, 255	# 2129
	jal		x0, ble_cont.10580	# 2129
ble.10579:
	lui		x5, 0	# 2129
	ori		x5, x0, 0	# 2129
	ble		x5, x4, ble.10581	# 2129
	lui		x4, 0	# 2129
	ori		x4, x0, 0	# 2129
	jal		x0, ble_cont.10582	# 2129
ble.10581:
ble_cont.10582:
ble_cont.10580:
...
write_rgb_element_char.2929:
	...
	lui		x5, 255	# 2135
	ori		x5, x0, 255	# 2135
	ble		x4, x5, ble.10583	# 2135
	lui		x4, 255	# 2135
	ori		x4, x0, 255	# 2135
	jal		x0, ble_cont.10584	# 2135
ble.10583:
	lui		x5, 0	# 2135
	ori		x5, x0, 0	# 2135
	ble		x5, x4, ble.10585	# 2135
	lui		x4, 0	# 2135
	ori		x4, x0, 0	# 2135
	jal		x0, ble_cont.10586	# 2135
ble.10585:
ble_cont.10586:
ble_cont.10584:
