...
beq_cont.33480:
	...
	lw		x11, -4(x2)	# 880
	sw		x11, 0(x5)	# 880
	addi	x11, x0, 40048	# 12
	lw		x12, 0(x2)	# 888
	arrsw	x5, x11, x12	# 888
	lw		x5, -24(x2)	# 890
...
beq_cont.33549:
	...
	fdiv	f1, f30, f1	# 1266
	arrfsw	f1, x4, x24	# 1266
	jal		x0, feq_cont.33541	# 120
feq.33542:
	arrfsw	f2, x4, x24	# 1263
feq_cont.33541:
...
beq.33568:
	fadd	f1, f0, f4	# 1027
beq_cont.33567:
	beq		x9, x24, beq.33570	# 1364
	jal		x0, beq_cont.33569	# 1364
beq.33570:
	fsub	f1, f1, f30	# 1364
beq_cont.33569:
	arrfsw	f1, x8, x24	# 1364
...
shadow_check_and_group.2928.18026:
	...
	addi	x8, x0, 40552	# 45
	add		x9, x0, x0	# 6
	arrflw	f1, x8, x0	# 1184
	lw		x10, 20(x7)	# 488
	arrflw	f2, x10, x0	# 493
	fsub	f2, f1, f2	# 1184
	arrflw	f3, x8, x21	# 1185
	arrflw	f4, x10, x21	# 503
	fsub	f4, f3, f4	# 1185
	arrflw	f5, x8, x22	# 1186
	arrflw	f6, x10, x22	# 513
	fsub	f6, f5, f6	# 1186
	addi	x8, x0, 40748	# 105
	arrlw	x6, x8, x6	# 1188
	lw		x8, 4(x7)	# 410
...
beq.33617:
	...
	fmul	f4, f7, f4	# 1156
	fadd	f2, f2, f4	# 1156
	arrflw	f4, x6, x24	# 1156
	fmul	f4, f4, f6	# 1156
	fadd	f2, f2, f4	# 1156
	addi	x6, x0, 40540	# 36
	arrfsw	f2, x6, x0	# 1155
	addi	x6, x0, 1	# 1157
...
shadow_check_one_or_matrix.2934.18032:
	...
	sw		x4, -8(x2)	# 1492
	sw		x0, -12(x2)	# 1492
	beq		x8, x28, beq.33677	# 1492
	addi	x9, x0, 40048	# 12
	arrlw	x9, x9, x8	# 1183
	addi	x10, x0, 40552	# 45
	arrflw	f1, x10, x0	# 1184
	lw		x11, 20(x9)	# 488
	arrflw	f2, x11, x0	# 493
	fsub	f1, f1, f2	# 1184
	add		x12, x0, x21	# 6
	arrflw	f2, x10, x21	# 1185
	arrflw	f3, x11, x21	# 503
	fsub	f2, f2, f3	# 1185
	arrflw	f3, x10, x22	# 1186
	arrflw	f4, x11, x22	# 513
	fsub	f3, f3, f4	# 1186
	addi	x10, x0, 40748	# 105
	arrlw	x8, x10, x8	# 1188
	lw		x10, 4(x9)	# 410
...
beq.33681:
	...
	fmul	f2, f4, f2	# 1156
	fadd	f1, f1, f2	# 1156
	arrflw	f2, x8, x24	# 1156
	fmul	f2, f2, f3	# 1156
	fadd	f1, f1, f2	# 1156
	addi	x8, x0, 40540	# 36
	arrfsw	f1, x8, x0	# 1155
	addi	x8, x0, 1	# 1157
...
trace_or_matrix.2945.18043:
	...
	sw		x5, -4(x2)	# 1578
	sw		x4, -8(x2)	# 1578
	beq		x9, x28, beq.33833	# 1578
	addi	x10, x0, 40048	# 12
	arrlw	x9, x10, x9	# 1089
...
fle_cont.33868:
	...
	addi	x10, x0, 40540	# 36
	arrfsw	f6, x10, x0	# 992
	addi	x10, x0, 1	# 992
...
solve_each_element_fast.2951.18047:
	...
	fmul	f2, f6, f2	# 1216
	fadd	f1, f1, f2	# 1216
	arrflw	f2, x17, x24	# 1216
	fmul	f2, f2, f3	# 1216
	fadd	f1, f1, f2	# 1216
	arrflw	f2, x12, x24	# 1217
	fmul	f3, f1, f1	# 127
	fmul	f2, f4, f2	# 1218
	fsub	f2, f3, f2	# 1218
	...
	fmul	f1, f1, f2	# 1221
	addi	x12, x0, 40540	# 36
	arrfsw	f1, x12, x0	# 1221
...
beq.33923:
	...
	arrflw	f2, x12, x24	# 1204
	fmul	f1, f1, f2	# 1204
	addi	x12, x0, 40540	# 36
	arrfsw	f1, x12, x0	# 1204
	addi	x12, x0, 1	# 1205
...
beq_cont.33920:
	...
	addi	x11, x0, 40540	# 36
	arrflw	f1, x11, x0	# 1624
	sw		x6, 0(x2)	# 125
	sw		x11, -4(x2)	# 125
	fsw		f0, -8(x2)	# 125
	sw		x7, -12(x2)	# 125
...
fle_cont.33969:
	...
	fmul	f2, f6, f2	# 1216
	fadd	f1, f1, f2	# 1216
	arrflw	f2, x10, x24	# 1216
	fmul	f2, f2, f3	# 1216
	fadd	f1, f1, f2	# 1216
	arrflw	f2, x8, x24	# 1217
	fmul	f3, f1, f1	# 127
	fmul	f2, f4, f2	# 1218
	fsub	f2, f3, f2	# 1218
...
beq.33968:
	...
	fmul	f2, f6, f2	# 1216
	fadd	f1, f1, f2	# 1216
	arrflw	f2, x11, x24	# 1216
	fmul	f2, f2, f3	# 1216
	fadd	f1, f1, f2	# 1216
	arrflw	f2, x10, x24	# 1217
	fmul	f3, f1, f1	# 127
	fmul	f2, f4, f2	# 1218
	fsub	f2, f3, f2	# 1218
...
beq.34039:
	...
	arrflw	f2, x10, x24	# 1204
	fmul	f1, f1, f2	# 1204
	addi	x10, x0, 40540	# 36
	arrfsw	f1, x10, x0	# 1204
	addi	x10, x0, 1	# 1205
...
solve_one_or_network_fast.2955.18051:
	...
	addi	x13, x0, 40048	# 12
	arrlw	x13, x13, x12	# 1230
	lw		x14, 40(x13)	# 605
	...
	arrflw	f2, x17, x30	# 1221
	fmul	f1, f1, f2	# 1221
	addi	x14, x0, 40540	# 36
	arrfsw	f1, x14, x0	# 1221
...
beq.34102:
	...
	arrflw	f2, x14, x24	# 1204
	fmul	f1, f1, f2	# 1204
	addi	x14, x0, 40540	# 36
	arrfsw	f1, x14, x0	# 1204
	addi	x14, x0, 1	# 1205
...
beq_cont.34099:
	...
	addi	x13, x0, 40540	# 36
	arrflw	f1, x13, x0	# 1624
	sw		x7, -24(x2)	# 125
...
trace_or_matrix_fast.2959.18055:
	...
	sw		x5, -4(x2)	# 1671
	sw		x4, -8(x2)	# 1671
	beq		x9, x28, beq.34162	# 1671
	addi	x11, x0, 40048	# 12
	arrlw	x11, x11, x9	# 1230
	lw		x12, 40(x11)	# 605
	arrflw	f1, x12, x0	# 1232
	arrflw	f2, x12, x21	# 1233
	add		x14, x0, x22	# 65
...
fle_cont.34238:
	...
	addi	x9, x0, 40552	# 45
	arrflw	f5, x9, x5	# 1727
	lw		x12, 20(x6)	# 488
	arrflw	f6, x12, x5	# 493
	fsub	f5, f5, f6	# 1727
	arrflw	f6, x9, x21	# 1728
	arrflw	f7, x12, x21	# 503
	fsub	f6, f6, f7	# 1728
	arrflw	f7, x9, x22	# 1729
...
beq_cont.34243:
	...
	arrflw	f6, x9, x21	# 317
	arrfsw	f6, x11, x21	# 317
	arrflw	f7, x9, x22	# 318
...
beq.34258:
	...
	fsub	f1, f10, f1	# 1781
	flw		f2, -88(x2)	# 125
	fle		f28, f2, fle.34280	# 125
	fle		f28, f1, fle.34282	# 125
	lui		x4, %hi(l.29635)	# 25
	ori		x4, x4, %lo(l.29635)	# 25
	flw		f1, 0(x4)	# 25
...
fle_cont.34308:
	...
	addi	x7, x0, 40552	# 45
	arrflw	f1, x7, x5	# 1727
	lw		x9, 20(x4)	# 488
	arrflw	f2, x9, x5	# 493
	fsub	f1, f1, f2	# 1727
	arrflw	f2, x7, x8	# 1728
	arrflw	f3, x9, x8	# 503
	fsub	f2, f2, f3	# 1728
	arrflw	f3, x7, x6	# 1729
	arrflw	f4, x9, x6	# 513
	fsub	f3, f3, f4	# 1729
	lw		x7, 16(x4)	# 448
	arrflw	f4, x7, x5	# 453
...
beq.34333:
	addi	x6, x0, 40552	# 45
	arrflw	f1, x6, x5	# 1798
	lw		x7, 20(x4)	# 488
	arrflw	f2, x7, x5	# 493
	fsub	f1, f1, f2	# 1798
	arrflw	f2, x6, x10	# 1799
	arrflw	f3, x7, x10	# 513
	fsub	f2, f2, f3	# 1799
	fmul	f1, f1, f1	# 127
	fmul	f2, f2, f2	# 127
...
beq.34329:
	...
	fsub	f1, f4, f1	# 1781
	flw		f2, -96(x2)	# 125
	fle		f28, f2, fle.34351	# 125
	fle		f28, f1, fle.34353	# 125
	lui		x4, %hi(l.29635)	# 25
	ori		x4, x4, %lo(l.29635)	# 25
	flw		f1, 0(x4)	# 25
...
fle_cont.34360:
	...
	addi	x6, x0, 40552	# 45
	arrflw	f1, x6, x5	# 1727
	lw		x9, 20(x4)	# 488
	arrflw	f2, x9, x5	# 493
	fsub	f1, f1, f2	# 1727
	arrflw	f2, x6, x7	# 1728
	arrflw	f3, x9, x7	# 503
	fsub	f2, f2, f3	# 1728
	arrflw	f3, x6, x8	# 1729
	arrflw	f4, x9, x8	# 513
	fsub	f3, f3, f4	# 1729
	lw		x6, 16(x4)	# 448
	arrflw	f4, x6, x5	# 453
...
beq.34381:
	...
	fsub	f1, f4, f1	# 1781
	flw		f2, -164(x2)	# 125
	fle		f28, f2, fle.34403	# 125
	fle		f28, f1, fle.34405	# 125
	lui		x4, %hi(l.29635)	# 25
	ori		x4, x4, %lo(l.29635)	# 25
	flw		f1, 0(x4)	# 25
...
beq_cont.34422:
	lw		x5, -40(x2)	# 2040
	beq		x5, x24, beq_cont.34424	# 2040
	addi	x6, x0, 40716	# 98
	arrlw	x4, x6, x24	# 2041
	lw		x6, -32(x2)	# 316
	lw		x7, -28(x2)	# 316
	arrflw	f1, x6, x7	# 316
	addi	x8, x0, 40648	# 78
