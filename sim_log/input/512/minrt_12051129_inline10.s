...
read_nth_object.2670:
	...
	flw		f2, -32(x2)	# 3
	fle		x31, f2, f1	# 3
	beq		x31, x0, fle_else.13301	# 3
	addi	x4, x0, 0	# 3
	jal		x0, fle_cont.13300	# 3
fle_else.13301:
	addi	x4, x0, 1	# 3
fle_cont.13300:
	lw		x5, -20(x2)	# 798
...
beq_cont.13302:
	lw		x4, -20(x2)	# 819
	lw		x5, -48(x2)	# 819
	beq		x5, x4, beq.13304	# 819
	lw		x4, -68(x2)	# 819
	jal		x0, beq_cont.13303	# 819
beq.13304:
	addi	x4, x0, 1	# 819
beq_cont.13303:
	addi	x6, x0, 4	# 820
	...
	sw		x5, 0(x9)	# 831
	lw		x5, -36(x2)	# 833
	beq		x8, x5, beq.13306	# 833
	addi	x5, x0, 2	# 843
	beq		x8, x5, beq.13308	# 843
	jal		x0, beq_cont.13307	# 843
beq.13308:
	addi	x5, x0, 0	# 845
	lw		x8, -68(x2)	# 845
	beq		x8, x5, beq.13310	# 845
	addi	x5, x0, 0	# 845
	jal		x0, beq_cont.13309	# 845
beq.13310:
	addi	x5, x0, 1	# 845
beq_cont.13309:
	lw		x27, -4(x2)	# 845
...
beq.13306:
	...
	flw		f2, 0(x8)	# 1
	feq		x31, f1, f2	# 1
	beq		x31, x0, feq_else.13312	# 1
	addi	x8, x0, 1	# 1
	jal		x0, feq_cont.13311	# 1
feq_else.13312:
	addi	x8, x0, 0	# 1
feq_cont.13311:
	addi	x9, x0, 0	# 837
	sw		x5, -100(x2)	# 837
	beq		x8, x9, beq.13314	# 837
	lui		x8, %hi(l.8174)	# 837
	ori		x8, x0, %lo(l.8174)	# 837
	flw		f1, 0(x8)	# 837
	jal		x0, beq_cont.13313	# 837
beq.13314:
	lw		x27, -8(x2)	# 837
	fsw		f1, -104(x2)	# 837
	sw		x1, -108(x2)	# 837
...
beq_cont.13313:
	...
	flw		f2, 0(x6)	# 1
	feq		x31, f1, f2	# 1
	beq		x31, x0, feq_else.13316	# 1
	addi	x6, x0, 1	# 1
	jal		x0, feq_cont.13315	# 1
feq_else.13316:
	addi	x6, x0, 0	# 1
feq_cont.13315:
	addi	x7, x0, 0	# 839
	sw		x4, -108(x2)	# 839
	beq		x6, x7, beq.13318	# 839
	lui		x6, %hi(l.8174)	# 839
	ori		x6, x0, %lo(l.8174)	# 839
	flw		f1, 0(x6)	# 839
	jal		x0, beq_cont.13317	# 839
beq.13318:
	lw		x27, -8(x2)	# 839
	fsw		f1, -112(x2)	# 839
	sw		x1, -116(x2)	# 839
...
feq_cont.13319:
	addi	x7, x0, 0	# 841
	sw		x4, -116(x2)	# 841
	beq		x6, x7, beq.13322	# 841
	lui		x6, %hi(l.8174)	# 841
	ori		x6, x0, %lo(l.8174)	# 841
	flw		f1, 0(x6)	# 841
	jal		x0, beq_cont.13321	# 841
beq.13322:
	lw		x27, -8(x2)	# 841
	fsw		f1, -120(x2)	# 841
	sw		x1, -124(x2)	# 841
...
read_object.2672:
	...
	lw		x1, -28(x2)	# 862
	lw		x5, -24(x2)	# 862
	beq		x4, x5, beq.13325	# 862
	lw		x4, -12(x2)	# 863
	lw		x6, -16(x2)	# 863
	add		x6, x6, x4	# 863
	lw		x7, -8(x2)	# 861
	ble		x7, x6, ble.13326	# 861
	lw		x27, -4(x2)	# 862
	sw		x6, -28(x2)	# 862
	addi	x4, x6, 0
	sw		x1, -32(x2)	# 862
...
solver_rect_surface.2684:
	...
	flw		f5, 0(x11)	# 928
	feq		x31, f5, f4	# 1
	beq		x31, x0, feq_else.13340	# 1
	addi	x11, x0, 1	# 1
	jal		x0, feq_cont.13339	# 1
feq_else.13340:
	addi	x11, x0, 0	# 1
feq_cont.13339:
	beq		x11, x10, beq.13341	# 928
	addi	x4, x0, 0	# 928
	jalr	x0, x1, 0	# 928
beq.13341:
	lw		x11, 16(x4)	# 421
	lw		x4, 24(x4)	# 373
	fle		x31, f4, f5	# 3
	beq		x31, x0, fle_else.13343	# 3
	addi	x12, x0, 0	# 3
	jal		x0, fle_cont.13342	# 3
fle_else.13343:
	addi	x12, x0, 1	# 3
fle_cont.13342:
	beq		x4, x10, beq.13345	# 204
	beq		x12, x10, beq.13347	# 204
	addi	x4, x0, 0	# 204
	jal		x0, beq_cont.13346	# 204
beq.13347:
	addi	x4, x0, 1	# 204
beq_cont.13346:
	jal		x0, beq_cont.13344	# 204
beq.13345:
	addi	x4, x12, 0	# 204
beq_cont.13344:
	addi	x12, x0, 4	# 930
	...
	add		x6, x11, x6	# 930
	flw		f6, 0(x6)	# 930
	beq		x4, x10, beq.13349	# 219
	jal		x0, beq_cont.13348	# 219
beq.13349:
	fsub	f6, f0, f6	# 4
beq_cont.13348:
	fsub	f1, f6, f1	# 932
...
fle_cont.13350:
	...
	flw		f5, 0(x4)	# 933
	fle		x31, f5, f2	# 6
	beq		x31, x0, fle_else.13352	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13351	# 6
fle_else.13352:
	addi	x4, x0, 1	# 6
fle_cont.13351:
	beq		x4, x10, beq.13353	# 933
	addi	x4, x0, 4	# 934
	mul		x4, x8, x4	# 934
	add		x4, x5, x4	# 934
	flw		f2, 0(x4)	# 934
...
fle_cont.13354:
	...
	flw		f3, 0(x4)	# 934
	fle		x31, f3, f2	# 6
	beq		x31, x0, fle_else.13356	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13355	# 6
fle_else.13356:
	addi	x4, x0, 1	# 6
fle_cont.13355:
	beq		x4, x10, beq.13357	# 934
	addi	x4, x0, 4	# 935
	mul		x4, x10, x4	# 935
	add		x4, x9, x4	# 935
	fsw		f1, 0(x4)	# 935
...
solver_surface.2699:
	...
	flw		f2, -28(x2)	# 2
	fle		x31, f1, f2	# 2
	beq		x31, x0, fle_else.13362	# 2
	addi	x4, x0, 0	# 2
	jal		x0, fle_cont.13361	# 2
fle_else.13362:
	addi	x4, x0, 1	# 2
fle_cont.13361:
	lw		x5, -24(x2)	# 956
	beq		x4, x5, beq.13363	# 956
	flw		f2, -12(x2)	# 957
	flw		f3, -8(x2)	# 957
	flw		f4, -4(x2)	# 957
	lw		x4, -16(x2)	# 957
...
solver_second.2718:
	...
	flw		f2, -48(x2)	# 1
	feq		x31, f1, f2	# 1
	beq		x31, x0, feq_else.13367	# 1
	addi	x4, x0, 1	# 1
	jal		x0, feq_cont.13366	# 1
feq_else.13367:
	addi	x4, x0, 0	# 1
feq_cont.13366:
	lw		x5, -44(x2)	# 1008
	beq		x4, x5, beq.13368	# 1008
	addi	x4, x0, 0	# 1009
	jalr	x0, x1, 0	# 1009
beq.13368:
	addi	x4, x0, 4	# 1013
	...
	lw		x5, 4(x4)	# 353
	lw		x6, -4(x2)	# 1016
	beq		x5, x6, beq.13370	# 1016
	jal		x0, beq_cont.13369	# 1016
beq.13370:
...
beq_cont.13369:
	...
	flw		f3, -48(x2)	# 2
	fle		x31, f1, f3	# 2
	beq		x31, x0, fle_else.13372	# 2
	addi	x5, x0, 0	# 2
	jal		x0, fle_cont.13371	# 2
fle_else.13372:
	addi	x5, x0, 1	# 2
fle_cont.13371:
	lw		x6, -44(x2)	# 1020
	beq		x5, x6, beq.13373	# 1020
	sw		x1, -60(x2)	# 1021
	addi	x2, x2, -64	# 1021
	...
	lw		x4, 24(x4)	# 373
	lw		x5, -44(x2)	# 1022
	beq		x4, x5, beq.13375	# 1022
	jal		x0, beq_cont.13374	# 1022
beq.13375:
	fsub	f1, f0, f1	# 4
beq_cont.13374:
	flw		f2, -56(x2)	# 1023
...
solver.2724:
	...
	fsub	f3, f3, f4	# 1036
	lw		x6, 4(x4)	# 353
	beq		x6, x13, beq.13376	# 1039
	beq		x6, x11, beq.13377	# 1040
	addi	x27, x8, 0
	lw		x31, 0(x27)	# 1041
	jalr	x0, x31, 0	# 1041
beq.13377:
...
fle_cont.13378:
	...
	flw		f9, 0(x13)	# 406
	fle		x31, f9, f8	# 6
	beq		x31, x0, fle_else.13380	# 6
	addi	x13, x0, 0	# 6
	jal		x0, fle_cont.13379	# 6
fle_else.13380:
	addi	x13, x0, 1	# 6
fle_cont.13379:
	beq		x13, x11, beq.13382	# 1066
	addi	x13, x0, 4	# 1067
	mul		x13, x9, x13	# 1067
	add		x13, x5, x13	# 1067
	flw		f8, 0(x13)	# 1067
...
fle_cont.13383:
	...
	flw		f9, 0(x13)	# 416
	fle		x31, f9, f8	# 6
	beq		x31, x0, fle_else.13385	# 6
	addi	x13, x0, 0	# 6
	jal		x0, fle_cont.13384	# 6
fle_else.13385:
	addi	x13, x0, 1	# 6
fle_cont.13384:
	beq		x13, x11, beq.13387	# 1067
	feq		x31, f6, f4	# 1
	beq		x31, x0, feq_else.13389	# 1
	addi	x13, x0, 1	# 1
	jal		x0, feq_cont.13388	# 1
feq_else.13389:
	addi	x13, x0, 0	# 1
feq_cont.13388:
	beq		x13, x11, beq.13391	# 1068
	addi	x13, x0, 0	# 1068
	jal		x0, beq_cont.13390	# 1068
beq.13391:
	addi	x13, x0, 1	# 1068
beq_cont.13390:
	jal		x0, beq_cont.13386	# 1067
beq.13387:
	addi	x13, x0, 0	# 1069
beq_cont.13386:
	jal		x0, beq_cont.13381	# 1066
beq.13382:
	addi	x13, x0, 0	# 1070
beq_cont.13381:
	beq		x13, x11, beq.13392	# 1065
	addi	x4, x0, 4	# 1072
	mul		x4, x11, x4	# 1072
	add		x4, x7, x4	# 1072
	fsw		f5, 0(x4)	# 1072
...
fle_cont.13393:
	...
	flw		f10, 0(x10)	# 396
	fle		x31, f10, f9	# 6
	beq		x31, x0, fle_else.13395	# 6
	addi	x10, x0, 0	# 6
	jal		x0, fle_cont.13394	# 6
fle_else.13395:
	addi	x10, x0, 1	# 6
fle_cont.13394:
	beq		x10, x11, beq.13397	# 1075
	addi	x10, x0, 4	# 1076
	mul		x10, x9, x10	# 1076
	add		x5, x5, x10	# 1076
	flw		f9, 0(x5)	# 1076
...
fle_cont.13398:
	...
	flw		f10, 0(x5)	# 416
	fle		x31, f10, f9	# 6
	beq		x31, x0, fle_else.13400	# 6
	addi	x5, x0, 0	# 6
	jal		x0, fle_cont.13399	# 6
fle_else.13400:
	addi	x5, x0, 1	# 6
fle_cont.13399:
	beq		x5, x11, beq.13402	# 1076
	feq		x31, f6, f4	# 1
	beq		x31, x0, feq_else.13404	# 1
	addi	x5, x0, 1	# 1
	jal		x0, feq_cont.13403	# 1
feq_else.13404:
	addi	x5, x0, 0	# 1
feq_cont.13403:
	beq		x5, x11, beq.13406	# 1077
	addi	x5, x0, 0	# 1077
	jal		x0, beq_cont.13405	# 1077
beq.13406:
	addi	x5, x0, 1	# 1077
beq_cont.13405:
	jal		x0, beq_cont.13401	# 1076
beq.13402:
	addi	x5, x0, 0	# 1078
beq_cont.13401:
	jal		x0, beq_cont.13396	# 1075
beq.13397:
	addi	x5, x0, 0	# 1079
beq_cont.13396:
	beq		x5, x11, beq.13407	# 1074
	addi	x4, x0, 4	# 1081
	mul		x4, x11, x4	# 1081
	add		x4, x7, x4	# 1081
	fsw		f5, 0(x4)	# 1081
...
fle_else.13410:
	addi	x5, x0, 1	# 6
fle_cont.13409:
	beq		x5, x11, beq.13412	# 1084
	fmul	f1, f3, f7	# 1085
	fadd	f1, f1, f2	# 1085
	fle		x31, f1, f4	# 5
	beq		x31, x0, fle_cont.13413	# 5
	fsub	f1, f0, f1	# 5
fle_cont.13413:
	lw		x4, 16(x4)	# 401
	addi	x5, x0, 4	# 406
	...
	flw		f2, 0(x4)	# 406
	fle		x31, f2, f1	# 6
	beq		x31, x0, fle_else.13415	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13414	# 6
fle_else.13415:
	addi	x4, x0, 1	# 6
fle_cont.13414:
	beq		x4, x11, beq.13417	# 1085
	feq		x31, f5, f4	# 1
	beq		x31, x0, feq_else.13419	# 1
	addi	x4, x0, 1	# 1
	jal		x0, feq_cont.13418	# 1
feq_else.13419:
	addi	x4, x0, 0	# 1
feq_cont.13418:
	beq		x4, x11, beq.13421	# 1086
	addi	x4, x0, 0	# 1086
	jal		x0, beq_cont.13420	# 1086
beq.13421:
	addi	x4, x0, 1	# 1086
beq_cont.13420:
	jal		x0, beq_cont.13416	# 1085
beq.13417:
	addi	x4, x0, 0	# 1087
beq_cont.13416:
	jal		x0, beq_cont.13411	# 1084
beq.13412:
	addi	x4, x0, 0	# 1088
beq_cont.13411:
	beq		x4, x11, beq.13422	# 1083
	addi	x4, x0, 4	# 1090
	mul		x4, x11, x4	# 1090
	add		x4, x7, x4	# 1090
	fsw		f3, 0(x4)	# 1090
...
solver_second_fast.2741:
	...
	flw		f5, 0(x12)	# 1107
	feq		x31, f5, f4	# 1
	beq		x31, x0, feq_else.13427	# 1
	addi	x12, x0, 1	# 1
	jal		x0, feq_cont.13426	# 1
feq_else.13427:
	addi	x12, x0, 0	# 1
feq_cont.13426:
	beq		x12, x10, beq.13428	# 1108
	addi	x4, x0, 0	# 1109
	jalr	x0, x1, 0	# 1109
beq.13428:
	addi	x12, x0, 4	# 1111
	...
	lw		x5, 4(x4)	# 353
	lw		x6, -24(x2)	# 1113
	beq		x5, x6, beq.13430	# 1113
	jal		x0, beq_cont.13429	# 1113
beq.13430:
...
fle_cont.13431:
	lw		x6, -8(x2)	# 1115
	beq		x5, x6, beq.13433	# 1115
	lw		x4, 24(x4)	# 373
	beq		x4, x6, beq.13435	# 1116
	addi	x4, x0, 0	# 1117
	sw		x4, -32(x2)	# 1117
	sw		x1, -36(x2)	# 1117
	addi	x2, x2, -40	# 1117
...
solver_fast.2747:
	...
	lw		x6, 0(x4)	# 1131
	lw		x4, 4(x10)	# 353
	beq		x4, x13, beq.13436	# 1133
	beq		x4, x11, beq.13437	# 1135
	addi	x5, x6, 0
	addi	x4, x10, 0
	addi	x27, x8, 0
	lw		x31, 0(x27)	# 1138
...
solver_surface_fast2.2751:
	...
	flw		f2, 0(x5)	# 1146
	fle		x31, f1, f2	# 3
	beq		x31, x0, fle_else.13439	# 3
	addi	x5, x0, 0	# 3
	jal		x0, fle_cont.13438	# 3
fle_else.13439:
	addi	x5, x0, 1	# 3
fle_cont.13438:
	beq		x5, x8, beq.13440	# 1146
	addi	x5, x0, 4	# 1147
	mul		x5, x7, x5	# 1147
	add		x5, x6, x5	# 1147
	flw		f1, 0(x5)	# 1147
...
solver_second_fast2.2758:
	...
	flw		f5, 0(x12)	# 1155
	feq		x31, f5, f4	# 1
	beq		x31, x0, feq_else.13442	# 1
	addi	x12, x0, 1	# 1
	jal		x0, feq_cont.13441	# 1
feq_else.13442:
	addi	x12, x0, 0	# 1
feq_cont.13441:
	beq		x12, x10, beq.13443	# 1156
	addi	x4, x0, 0	# 1157
	jalr	x0, x1, 0	# 1157
beq.13443:
	addi	x12, x0, 4	# 1159
	...
	fsub	f2, f3, f2	# 1161
	fle		x31, f2, f4	# 2
	beq		x31, x0, fle_else.13445	# 2
	addi	x6, x0, 0	# 2
	jal		x0, fle_cont.13444	# 2
fle_else.13445:
	addi	x6, x0, 1	# 2
fle_cont.13444:
	beq		x6, x10, beq.13446	# 1162
	lw		x4, 24(x4)	# 373
	beq		x4, x10, beq.13448	# 1163
	addi	x4, x0, 0	# 1164
	sw		x7, 0(x2)	# 1164
	sw		x4, -4(x2)	# 1164
	sw		x5, -8(x2)	# 1164
...
solver_fast2.2765:
	...
	lw		x4, 0(x4)	# 1179
	lw		x11, 4(x9)	# 353
	beq		x11, x12, beq.13449	# 1181
	beq		x11, x10, beq.13450	# 1183
	addi	x6, x13, 0
	addi	x5, x4, 0
	addi	x27, x7, 0
	addi	x4, x9, 0
...
beq.13454:
	...
	flw		f3, 0(x10)	# 3
	fle		x31, f3, f1	# 3
	beq		x31, x0, fle_else.13456	# 3
	addi	x10, x0, 0	# 3
	jal		x0, fle_cont.13455	# 3
fle_else.13456:
	addi	x10, x0, 1	# 3
fle_cont.13455:
	addi	x11, x0, 0	# 204
	beq		x9, x11, beq.13458	# 204
	beq		x10, x11, beq.13460	# 204
	addi	x9, x0, 0	# 204
	jal		x0, beq_cont.13459	# 204
beq.13460:
	addi	x9, x0, 1	# 204
beq_cont.13459:
	jal		x0, beq_cont.13457	# 204
beq.13458:
	addi	x9, x10, 0	# 204
beq_cont.13457:
	lw		x10, 16(x8)	# 391
	...
	flw		f1, 0(x10)	# 396
	addi	x10, x0, 0	# 219
	beq		x9, x10, beq.13462	# 219
	jal		x0, beq_cont.13461	# 219
beq.13462:
	fsub	f1, f0, f1	# 4
beq_cont.13461:
	addi	x9, x0, 4	# 1201
...
fle_cont.13479:
	addi	x10, x0, 0	# 204
	beq		x8, x10, beq.13482	# 204
	beq		x9, x10, beq.13484	# 204
	addi	x8, x0, 0	# 204
...
setup_surface_table.2771:
	...
	flw		f2, 0(x2)	# 2
	fle		x31, f1, f2	# 2
	beq		x31, x0, fle_else.13488	# 2
	addi	x7, x0, 0	# 2
	jal		x0, fle_cont.13487	# 2
fle_else.13488:
	addi	x7, x0, 1	# 2
fle_cont.13487:
	beq		x7, x6, beq.13490	# 1226
	addi	x6, x0, 0	# 1228
...
beq_cont.13491:
	flw		f2, 0(x2)	# 1
	feq		x31, f1, f2	# 1
	beq		x31, x0, feq_else.13494	# 1
	addi	x4, x0, 1	# 1
	jal		x0, feq_cont.13493	# 1
feq_else.13494:
	addi	x4, x0, 0	# 1
feq_cont.13493:
	beq		x4, x5, beq.13496	# 1261
	jal		x0, beq_cont.13495	# 1261
beq.13496:
	addi	x4, x0, 4	# 1262
...
ble.13497:
	...
	sw		x27, -4(x2)	# 1275
	sw		x11, -8(x2)	# 1275
	beq		x13, x11, beq.13500	# 1275
	addi	x8, x0, 2	# 1277
	beq		x13, x8, beq.13502	# 1277
	sw		x10, -12(x2)	# 1280
	sw		x5, -16(x2)	# 1280
	addi	x5, x9, 0
	addi	x4, x12, 0
...
ble.13503:
	...
	sw		x11, -8(x2)	# 1302
	sw		x5, -12(x2)	# 1302
	beq		x13, x9, beq.13506	# 1302
	addi	x6, x0, 2	# 1305
	ble		x13, x6, ble_cont.13507	# 1305
	addi	x6, x0, 0	# 1306
	addi	x9, x0, 4	# 1306
	mul		x6, x6, x9	# 1306
	add		x6, x12, x6	# 1306
	...
	addi	x5, x0, 3	# 1307
	lw		x6, -20(x2)	# 1307
	beq		x6, x5, beq.13509	# 1307
	jal		x0, beq_cont.13508	# 1307
beq.13509:
...
fle_cont.13510:
	...
	flw		f5, 0(x8)	# 396
	fle		x31, f5, f1	# 6
	beq		x31, x0, fle_else.13512	# 6
	addi	x8, x0, 0	# 6
	jal		x0, fle_cont.13511	# 6
fle_else.13512:
	addi	x8, x0, 1	# 6
fle_cont.13511:
	beq		x8, x6, beq.13514	# 1327
	fle		x31, f2, f4	# 5
	beq		x31, x0, fle_else.13516	# 5
	fsub	f1, f0, f2	# 5
	jal		x0, fle_cont.13515	# 5
fle_else.13516:
	fadd	f1, f0, f2	# 5
fle_cont.13515:
	lw		x8, 16(x4)	# 401
	...
	flw		f2, 0(x7)	# 406
	fle		x31, f2, f1	# 6
	beq		x31, x0, fle_else.13518	# 6
	addi	x7, x0, 0	# 6
	jal		x0, fle_cont.13517	# 6
fle_else.13518:
	addi	x7, x0, 1	# 6
fle_cont.13517:
	beq		x7, x6, beq.13520	# 1328
	fle		x31, f3, f4	# 5
	beq		x31, x0, fle_else.13522	# 5
	fsub	f1, f0, f3	# 5
	jal		x0, fle_cont.13521	# 5
fle_else.13522:
	fadd	f1, f0, f3	# 5
fle_cont.13521:
	lw		x7, 16(x4)	# 411
...
fle_else.13524:
	addi	x5, x0, 1	# 6
fle_cont.13523:
	jal		x0, beq_cont.13519	# 1328
beq.13520:
	addi	x5, x0, 0	# 1330
beq_cont.13519:
	jal		x0, beq_cont.13513	# 1327
beq.13514:
	addi	x5, x0, 0	# 1331
beq_cont.13513:
	beq		x5, x6, beq.13525	# 1326
	lw		x4, 24(x4)	# 373
	jalr	x0, x1, 0	# 377
beq.13525:
	lw		x4, 24(x4)	# 373
	beq		x4, x6, beq.13526	# 1332
	addi	x4, x0, 0	# 1332
	jalr	x0, x1, 0	# 1332
beq.13526:
	addi	x4, x0, 1	# 1332
...
is_plane_outside.2792:
	...
	flw		f2, -4(x2)	# 3
	fle		x31, f2, f1	# 3
	beq		x31, x0, fle_else.13528	# 3
	addi	x5, x0, 0	# 3
	jal		x0, fle_cont.13527	# 3
fle_else.13528:
	addi	x5, x0, 1	# 3
fle_cont.13527:
	lw		x6, 0(x2)	# 204
	beq		x4, x6, beq.13530	# 204
	beq		x5, x6, beq.13532	# 204
	addi	x4, x0, 0	# 204
	jal		x0, beq_cont.13531	# 204
beq.13532:
	addi	x4, x0, 1	# 204
beq_cont.13531:
	jal		x0, beq_cont.13529	# 204
beq.13530:
	addi	x4, x5, 0	# 204
beq_cont.13529:
	beq		x4, x6, beq.13533	# 1338
	addi	x4, x0, 0	# 1338
	jalr	x0, x1, 0	# 1338
beq.13533:
	addi	x4, x0, 1	# 1338
...
is_second_outside.2797:
	...
	lw		x5, 4(x4)	# 353
	lw		x6, -8(x2)	# 1344
	beq		x5, x6, beq.13535	# 1344
	jal		x0, beq_cont.13534	# 1344
beq.13535:
...
beq_cont.13534:
	...
	flw		f2, -4(x2)	# 3
	fle		x31, f2, f1	# 3
	beq		x31, x0, fle_else.13537	# 3
	addi	x5, x0, 0	# 3
	jal		x0, fle_cont.13536	# 3
fle_else.13537:
	addi	x5, x0, 1	# 3
fle_cont.13536:
	lw		x6, 0(x2)	# 204
	beq		x4, x6, beq.13539	# 204
	beq		x5, x6, beq.13541	# 204
	addi	x4, x0, 0	# 204
	jal		x0, beq_cont.13540	# 204
beq.13541:
	addi	x4, x0, 1	# 204
beq_cont.13540:
	jal		x0, beq_cont.13538	# 204
beq.13539:
	addi	x4, x5, 0	# 204
beq_cont.13538:
	beq		x4, x6, beq.13542	# 1345
	addi	x4, x0, 0	# 1345
	jalr	x0, x1, 0	# 1345
beq.13542:
	addi	x4, x0, 1	# 1345
...
is_outside.2802:
	...
	fsub	f3, f3, f4	# 1352
	lw		x9, 4(x4)	# 353
	beq		x9, x10, beq.13543	# 1354
	beq		x9, x8, beq.13544	# 1356
	addi	x27, x5, 0
	lw		x31, 0(x27)	# 1359
	jalr	x0, x31, 0	# 1359
beq.13544:
...
shadow_check_and_group.2813:
	...
	add		x5, x7, x5	# 1389
	flw		f1, 0(x5)	# 1389
	beq		x4, x6, beq.13549	# 1390
	lui		x4, %hi(l.9220)	# 1390
	ori		x4, x0, %lo(l.9220)	# 1390
	flw		f2, 0(x4)	# 1390
	fle		x31, f2, f1	# 6
	beq		x31, x0, fle_else.13551	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13550	# 6
fle_else.13551:
	addi	x4, x0, 1	# 6
fle_cont.13550:
	jal		x0, beq_cont.13548	# 1390
beq.13549:
	addi	x4, x0, 0	# 1390
beq_cont.13548:
	beq		x4, x6, beq.13552	# 1390
...
fle_cont.13562:
	...
	lw		x1, -32(x2)	# 1443
	addi	x5, x0, 0	# 1443
	beq		x4, x5, beq.13567	# 1443
	addi	x4, x0, 1	# 1444
	jal		x0, beq_cont.13566	# 1443
beq.13567:
	addi	x4, x0, 0	# 1445
beq_cont.13566:
	jal		x0, beq_cont.13564	# 1442
beq.13565:
	addi	x4, x0, 0	# 1446
beq_cont.13564:
	jal		x0, beq_cont.13560	# 1441
beq.13561:
	addi	x4, x0, 0	# 1447
beq_cont.13560:
	jal		x0, beq_cont.13558	# 1435
beq.13559:
	addi	x4, x0, 1	# 1436
beq_cont.13558:
	lw		x5, -24(x2)	# 1434
	beq		x4, x5, beq.13568	# 1434
	lw		x4, -16(x2)	# 1449
	lw		x6, 0(x2)	# 1449
	lw		x27, -4(x2)	# 1449
	addi	x5, x6, 0
...
solve_each_element.2822:
	...
	flw		f2, -28(x2)	# 6
	fle		x31, f1, f2	# 6
	beq		x31, x0, fle_else.13573	# 6
	addi	x6, x0, 0	# 6
	jal		x0, fle_cont.13572	# 6
fle_else.13573:
	addi	x6, x0, 1	# 6
fle_cont.13572:
	beq		x6, x5, beq_cont.13574	# 1475
	addi	x6, x0, 0	# 1476
	addi	x7, x0, 4	# 1476
	mul		x6, x6, x7	# 1476
	lw		x7, -24(x2)	# 1476
...
trace_or_matrix.2830:
	...
	flw		f2, 0(x4)	# 1529
	fle		x31, f2, f1	# 6
	beq		x31, x0, fle_else.13589	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13588	# 6
fle_else.13589:
	addi	x4, x0, 1	# 6
fle_cont.13588:
	addi	x5, x0, 0	# 1529
	beq		x4, x5, beq_cont.13590	# 1529
	addi	x4, x0, 1	# 1530
	lw		x5, -20(x2)	# 1530
	lw		x6, 0(x2)	# 1530
	lw		x27, -24(x2)	# 1530
...
judge_intersection.2834:
	...
	flw		f2, 0(x4)	# 1547
	fle		x31, f1, f2	# 6
	beq		x31, x0, fle_else.13593	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13592	# 6
fle_else.13593:
	addi	x4, x0, 1	# 6
fle_cont.13592:
	beq		x4, x5, beq.13594	# 1547
	lui		x4, %hi(l.9339)	# 1548
	ori		x4, x0, %lo(l.9339)	# 1548
	flw		f2, 0(x4)	# 1548
	fle		x31, f2, f1	# 6
	beq		x31, x0, fle_else.13595	# 6
	addi	x4, x0, 0	# 6
	jalr	x0, x1, 0	# 6
fle_else.13595:
	addi	x4, x0, 1	# 6
...
fle_cont.13598:
	...
	flw		f2, 0(x6)	# 1570
	fle		x31, f2, f1	# 6
	beq		x31, x0, fle_else.13602	# 6
	addi	x6, x0, 0	# 6
	jal		x0, fle_cont.13601	# 6
fle_else.13602:
	addi	x6, x0, 1	# 6
fle_cont.13601:
	addi	x8, x0, 0	# 1570
	beq		x6, x8, beq_cont.13603	# 1570
...
trace_or_matrix_fast.2844:
	...
	flw		f2, 0(x4)	# 1622
	fle		x31, f2, f1	# 6
	beq		x31, x0, fle_else.13615	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13614	# 6
fle_else.13615:
	addi	x4, x0, 1	# 6
fle_cont.13614:
	addi	x5, x0, 0	# 1622
	beq		x4, x5, beq_cont.13616	# 1622
	addi	x4, x0, 1	# 1623
	lw		x5, -20(x2)	# 1623
	lw		x6, 0(x2)	# 1623
	lw		x27, -24(x2)	# 1623
...
fle_else.13619:
	addi	x4, x0, 1	# 6
fle_cont.13618:
	beq		x4, x5, beq.13620	# 1638
	lui		x4, %hi(l.9339)	# 1639
	ori		x4, x0, %lo(l.9339)	# 1639
	flw		f2, 0(x4)	# 1639
	fle		x31, f2, f1	# 6
	beq		x31, x0, fle_else.13621	# 6
	addi	x4, x0, 0	# 6
	jalr	x0, x1, 0	# 6
fle_else.13621:
	addi	x4, x0, 1	# 6
...
utexture.2859:
	...
	add		x15, x6, x15	# 1712
	fsw		f4, 0(x15)	# 1712
	beq		x14, x13, beq.13626	# 1713
	beq		x14, x10, beq.13627	# 1731
	beq		x14, x11, beq.13628	# 1738
	addi	x7, x0, 4	# 1749
	beq		x14, x7, beq.13629	# 1749
	jalr	x0, x1, 0	# 1777
beq.13629:
	addi	x7, x0, 4	# 1751
	mul		x7, x12, x7	# 1751
	...
	flw		f4, -20(x2)	# 5
	fle		x31, f2, f4	# 5
	beq		x31, x0, fle_else.13632	# 5
	fsub	f5, f0, f2	# 5
	jal		x0, fle_cont.13631	# 5
fle_else.13632:
	fadd	f5, f0, f2	# 5
fle_cont.13631:
...
fle_cont.13633:
	...
	fsw		f6, -48(x2)	# 1755
	fsw		f3, -52(x2)	# 1755
	beq		x4, x5, beq.13636	# 1755
	lui		x4, %hi(l.9559)	# 1756
	ori		x4, x0, %lo(l.9559)	# 1756
	flw		f1, 0(x4)	# 1756
	jal		x0, beq_cont.13635	# 1755
beq.13636:
	fdiv	f1, f1, f2	# 1758
	lui		x4, %hi(l.8174)	# 5
...
beq_cont.13635:
	...
	flw		f3, -52(x2)	# 5
	fle		x31, f3, f2	# 5
	beq		x31, x0, fle_else.13639	# 5
	fsub	f4, f0, f3	# 5
	jal		x0, fle_cont.13638	# 5
fle_else.13639:
	fadd	f4, f0, f3	# 5
fle_cont.13638:
	flw		f5, -48(x2)	# 6
	fle		x31, f5, f4	# 6
	beq		x31, x0, fle_else.13641	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13640	# 6
fle_else.13641:
	addi	x4, x0, 1	# 6
fle_cont.13640:
	lw		x5, -16(x2)	# 1766
	beq		x4, x5, beq.13643	# 1766
	lui		x4, %hi(l.9559)	# 1767
	ori		x4, x0, %lo(l.9559)	# 1767
	flw		f1, 0(x4)	# 1767
	jal		x0, beq_cont.13642	# 1766
beq.13643:
	fdiv	f1, f1, f3	# 1769
	lui		x4, %hi(l.8174)	# 5
	ori		x4, x0, %lo(l.8174)	# 5
...
beq_cont.13642:
	...
	flw		f2, -20(x2)	# 3
	fle		x31, f2, f1	# 3
	beq		x31, x0, fle_else.13646	# 3
	addi	x4, x0, 0	# 3
	jal		x0, fle_cont.13645	# 3
fle_else.13646:
	addi	x4, x0, 1	# 3
fle_cont.13645:
	lw		x5, -16(x2)	# 1774
	beq		x4, x5, beq_cont.13647	# 1774
	fadd	f1, f0, f2	# 1774
beq_cont.13647:
	flw		f2, -4(x2)	# 1775
	fmul	f1, f2, f1	# 1775
...
fle_cont.13651:
	...
	flw		f2, -96(x2)	# 6
	fle		x31, f2, f1	# 6
	beq		x31, x0, fle_else.13654	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13653	# 6
fle_else.13654:
	addi	x4, x0, 1	# 6
fle_cont.13653:
	lw		x5, -16(x2)	# 1727
	lw		x6, -92(x2)	# 1727
	beq		x6, x5, beq.13656	# 1727
	beq		x4, x5, beq.13658	# 1728
	flw		f1, -4(x2)	# 1728
	jal		x0, beq_cont.13657	# 1728
beq.13658:
	flw		f1, -20(x2)	# 1728
beq_cont.13657:
	jal		x0, beq_cont.13655	# 1727
beq.13656:
	beq		x4, x5, beq.13660	# 1729
	flw		f1, -20(x2)	# 1729
	jal		x0, beq_cont.13659	# 1729
beq.13660:
	flw		f1, -4(x2)	# 1729
beq_cont.13659:
beq_cont.13655:
...
add_light.2862:
	...
	flw		f4, 4(x27)	# 2
	fle		x31, f1, f4	# 2
	beq		x31, x0, fle_else.13663	# 2
	addi	x10, x0, 0	# 2
	jal		x0, fle_cont.13662	# 2
fle_else.13663:
	addi	x10, x0, 1	# 2
fle_cont.13662:
	sw		x7, 0(x2)	# 1788
	...
	fsw		f4, -20(x2)	# 1788
	fsw		f2, -24(x2)	# 1788
	beq		x10, x8, beq_cont.13664	# 1788
	addi	x27, x4, 0
	addi	x4, x6, 0
	sw		x1, -28(x2)	# 1789
	addi	x2, x2, -32	# 1789
...
beq_cont.13664:
	...
	flw		f2, -24(x2)	# 2
	fle		x31, f2, f1	# 2
	beq		x31, x0, fle_else.13666	# 2
	addi	x4, x0, 0	# 2
	jal		x0, fle_cont.13665	# 2
fle_else.13666:
	addi	x4, x0, 1	# 2
fle_cont.13665:
	lw		x5, -16(x2)	# 1793
	beq		x4, x5, beq.13667	# 1793
	fmul	f1, f2, f2	# 8
	fmul	f1, f1, f1	# 8
	flw		f2, -12(x2)	# 1794
	fmul	f1, f1, f2	# 1794
...
ble.13670:
	...
	lw		x5, -48(x2)	# 655
	lw		x6, 0(x5)	# 655
	beq		x4, x6, beq.13674	# 1811
	jal		x0, beq_cont.13673	# 1811
beq.13674:
	addi	x4, x0, 0	# 1813
	addi	x6, x0, 0	# 1813
	addi	x7, x0, 4	# 1813
	...
	lw		x1, -64(x2)	# 1813
	addi	x5, x0, 0	# 1813
	beq		x4, x5, beq.13676	# 1813
	jal		x0, beq_cont.13675	# 1813
beq.13676:
	lw		x4, -36(x2)	# 639
	lw		x5, 0(x4)	# 639
	lw		x6, -28(x2)	# 1815
...
ble.13677:
	...
	sw		x4, -168(x2)	# 1693
	sw		x6, -172(x2)	# 1693
	beq		x8, x9, beq.13681	# 1693
	lw		x10, -108(x2)	# 1695
	beq		x8, x10, beq.13683	# 1695
	lw		x27, -88(x2)	# 1698
	addi	x4, x6, 0
	sw		x1, -176(x2)	# 1698
	addi	x2, x2, -180	# 1698
...
beq_cont.13680:
	...
	flw		f2, 0(x7)	# 1852
	fle		x31, f2, f1	# 6
	beq		x31, x0, fle_else.13685	# 6
	addi	x7, x0, 0	# 6
	jal		x0, fle_cont.13684	# 6
fle_else.13685:
	addi	x7, x0, 1	# 6
fle_cont.13684:
	beq		x7, x9, beq.13687	# 1852
	addi	x7, x0, 0	# 1853
	addi	x8, x0, 4	# 1853
	lw		x10, -152(x2)	# 1853
	mul		x8, x10, x8	# 1853
...
beq_cont.13686:
	...
	lw		x1, -188(x2)	# 1870
	lw		x5, -156(x2)	# 1870
	beq		x4, x5, beq.13689	# 1870
	jal		x0, beq_cont.13688	# 1870
beq.13689:
	lw		x4, -40(x2)	# 1871
	lw		x6, -132(x2)	# 1871
	lw		x27, -140(x2)	# 1871
...
beq_cont.13688:
	...
	flw		f2, -124(x2)	# 6
	fle		x31, f2, f1	# 6
	beq		x31, x0, fle_else.13691	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13690	# 6
fle_else.13691:
	addi	x4, x0, 1	# 6
fle_cont.13690:
	lw		x5, -156(x2)	# 1881
	beq		x4, x5, beq.13692	# 1881
	lw		x4, -152(x2)	# 1883
	lw		x6, -68(x2)	# 1883
	ble		x6, x4, ble_cont.13693	# 1883
	addi	x6, x4, 1	# 1884
	addi	x7, x0, -1	# 1884
	addi	x8, x0, 4	# 1884
	mul		x6, x6, x8	# 1884
...
beq.13679:
	...
	flw		f2, -128(x2)	# 2
	fle		x31, f1, f2	# 2
	beq		x31, x0, fle_else.13699	# 2
	addi	x4, x0, 0	# 2
	jal		x0, fle_cont.13698	# 2
fle_else.13699:
	addi	x4, x0, 1	# 2
fle_cont.13698:
	lw		x5, -156(x2)	# 1902
	beq		x4, x5, beq.13700	# 1902
	fmul	f2, f1, f1	# 8
	fmul	f1, f2, f1	# 1905
	flw		f2, -124(x2)	# 1905
	fmul	f1, f1, f2	# 1905
...
trace_diffuse_ray.2877:
	...
	lw		x8, -64(x2)	# 1693
	sw		x4, -84(x2)	# 1693
	beq		x7, x8, beq.13706	# 1693
	lw		x6, -56(x2)	# 1695
	beq		x7, x6, beq.13708	# 1695
	lw		x27, -48(x2)	# 1698
	sw		x1, -88(x2)	# 1698
	addi	x2, x2, -92	# 1698
	lw		x31, 0(x27)	# 1698
...
beq.13709:
	...
	flw		f2, -16(x2)	# 2
	fle		x31, f1, f2	# 2
	beq		x31, x0, fle_else.13712	# 2
	addi	x4, x0, 0	# 2
	jal		x0, fle_cont.13711	# 2
fle_else.13712:
	addi	x4, x0, 1	# 2
fle_cont.13711:
	lw		x5, -80(x2)	# 1935
	beq		x4, x5, beq.13714	# 1935
	jal		x0, beq_cont.13713	# 1935
beq.13714:
	fadd	f1, f0, f2	# 1935
beq_cont.13713:
	flw		f2, -12(x2)	# 1936
...
ble.13716:
	...
	flw		f2, -32(x2)	# 3
	fle		x31, f2, f1	# 3
	beq		x31, x0, fle_else.13719	# 3
	addi	x4, x0, 0	# 3
	jal		x0, fle_cont.13718	# 3
fle_else.13719:
	addi	x4, x0, 1	# 3
fle_cont.13718:
	lw		x5, -28(x2)	# 1949
	beq		x4, x5, beq.13721	# 1949
	lw		x4, -24(x2)	# 1950
	addi	x5, x4, 1	# 1950
	addi	x6, x0, 4	# 1950
	mul		x5, x5, x6	# 1950
...
trace_diffuse_ray_80percent.2889:
	...
	sw		x16, -44(x2)	# 1971
	sw		x4, -48(x2)	# 1971
	beq		x4, x15, beq_cont.13722	# 1971
	addi	x17, x0, 0	# 1972
	addi	x18, x0, 4	# 1972
...
neighbors_exist.2905:
	...
	lw		x9, 0(x9)	# 2050
	add		x10, x5, x8	# 2050
	ble		x9, x10, ble.13733	# 2050
	ble		x5, x7, ble.13734	# 2051
	addi	x5, x0, 4	# 2052
	mul		x5, x7, x5	# 2052
	add		x5, x6, x5	# 2052
	lw		x5, 0(x5)	# 2052
	add		x6, x4, x8	# 2052
	ble		x5, x6, ble.13735	# 2052
	ble		x4, x7, ble.13736	# 2053
	addi	x4, x0, 1	# 2054
	jalr	x0, x1, 0	# 2054
ble.13736:
	addi	x4, x0, 0	# 2055
...
write_rgb_element_int.2927:
	...
	lw		x1, -4(x2)	# 2128
	addi	x5, x0, 255	# 2129
	ble		x4, x5, ble.13748	# 2129
	addi	x4, x0, 255	# 2129
	jal		x0, ble_cont.13747	# 2129
ble.13748:
	lw		x5, 0(x2)	# 2129
	ble		x5, x4, ble_cont.13749	# 2129
	addi	x4, x0, 0	# 2129
ble_cont.13749:
ble_cont.13747:
...
write_rgb_element_char.2929:
	...
	lw		x1, -4(x2)	# 2134
	addi	x5, x0, 255	# 2135
	ble		x4, x5, ble.13751	# 2135
	addi	x4, x0, 255	# 2135
	jal		x0, ble_cont.13750	# 2135
ble.13751:
	lw		x5, 0(x2)	# 2135
	ble		x5, x4, ble_cont.13752	# 2135
	addi	x4, x0, 0	# 2135
ble_cont.13752:
ble_cont.13750:
...
ble.13756:
	...
	sw		x15, -8(x2)	# 2170
	sw		x5, -12(x2)	# 2170
	beq		x16, x14, beq_cont.13758	# 2170
	lw		x16, 24(x4)	# 614
	addi	x17, x0, 0	# 616
	addi	x18, x0, 4	# 616
	mul		x17, x17, x18	# 616
...
ble.13759:
	...
	add		x4, x6, x4	# 224
	lw		x6, -4(x2)	# 225
	ble		x6, x4, ble.13762	# 225
	addi	x6, x4, 0	# 225
	jal		x0, ble_cont.13761	# 225
ble.13762:
	sub		x6, x4, x6	# 225
ble_cont.13761:
	flw		f1, -72(x2)	# 2211
...
scan_line.2954:
	...
	sw		x15, -40(x2)	# 2257
	sw		x10, -44(x2)	# 2257
	ble		x12, x4, ble_cont.13768	# 2257
	addi	x12, x4, 1	# 2258
	addi	x6, x8, 0
	addi	x5, x12, 0
	addi	x4, x7, 0
...
ble_cont.13768:
	...
	add		x5, x6, x5	# 224
	lw		x6, -4(x2)	# 225
	ble		x6, x5, ble.13770	# 225
	addi	x8, x5, 0	# 225
	jal		x0, ble_cont.13769	# 225
ble.13770:
	sub		x8, x5, x6	# 225
ble_cont.13769:
	lw		x5, -28(x2)	# 2261
...
ble.13775:
	...
	add		x4, x6, x4	# 224
	lw		x6, -4(x2)	# 225
	ble		x6, x4, ble.13778	# 225
	jal		x0, ble_cont.13777	# 225
ble.13778:
	sub		x4, x4, x6	# 225
ble_cont.13777:
	flw		f1, -20(x2)	# 2363
...
ble.13779:
	...
	add		x5, x6, x5	# 224
	lw		x6, -4(x2)	# 225
	ble		x6, x5, ble.13782	# 225
	jal		x0, ble_cont.13781	# 225
ble.13782:
	sub		x5, x5, x6	# 225
ble_cont.13781:
	lw		x6, -20(x2)	# 2372
...
beq.13796:
	...
	flw		f2, 0(x11)	# 2473
	fle		x31, f2, f1	# 6
	beq		x31, x0, fle_else.13799	# 6
	addi	x11, x0, 0	# 6
	jal		x0, fle_cont.13798	# 6
fle_else.13799:
	addi	x11, x0, 1	# 6
fle_cont.13798:
	beq		x11, x9, beq.13800	# 2473
	lw		x9, 4(x7)	# 353
	beq		x9, x10, beq.13801	# 2476
	beq		x9, x8, beq.13802	# 2478
	jalr	x0, x1, 0	# 2480
beq.13802:
	addi	x27, x5, 0
	addi	x5, x7, 0
