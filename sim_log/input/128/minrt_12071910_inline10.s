...
int_of_float.2487:
	fadd	f2, f0, f0	# 10
	fle		x31, f2, f1	# 10
	beq		x31, x0, fle_else.13207	# 10
	fadd	f2, f0, f16	# 11
	fle		x31, f2, f1	# 11
	beq		x31, x0, fle_else.13208	# 11
	fsub	f1, f1, f2	# 11
	sw		x1, 0(x2)	# 11
	addi	x2, x2, -4	# 11
...
sin.2501:
	...
	fadd	f6, f0, f0	# 46
	fle		x31, f6, f1	# 46
	beq		x31, x0, fle_else.13212	# 46
	fle		x31, f4, f1	# 47
	beq		x31, x0, fle_else.13213	# 47
	fsub	f1, f1, f4	# 47
	lw		x31, 0(x27)	# 47
	jalr	x0, x31, 0	# 47
fle_else.13213:
	fle		x31, f5, f1	# 48
	beq		x31, x0, fle_else.13214	# 48
	fsub	f1, f1, f5	# 48
	sw		x1, 0(x2)	# 48
	addi	x2, x2, -4	# 48
	lw		x31, 0(x27)	# 48
...
fle_else.13214:
	fle		x31, f1, f3	# 49
	beq		x31, x0, fle_else.13215	# 49
	fle		x31, f2, f1	# 50
	beq		x31, x0, fle_else.13216	# 50
	fsub	f1, f3, f1	# 50
...
cos.2503:
	...
	fadd	f4, f0, f0	# 54
	fle		x31, f4, f1	# 54
	beq		x31, x0, fle_else.13217	# 54
	fle		x31, f1, f2	# 55
	beq		x31, x0, fle_else.13218	# 55
...
atan.2505:
	...
	fadd	f4, f0, f0	# 59
	fle		x31, f4, f1	# 59
	beq		x31, x0, fle_else.13219	# 59
	lui		x4, %hi(l.8197)	# 60
	ori		x4, x0, %lo(l.8197)	# 60
	flw		f4, 0(x4)	# 60
	fle		x31, f1, f4	# 60
	beq		x31, x0, fle_else.13220	# 60
	lui		x4, %hi(l.8200)	# 61
	ori		x4, x0, %lo(l.8200)	# 61
	flw		f3, 0(x4)	# 61
	fle		x31, f3, f1	# 61
	beq		x31, x0, fle_else.13221	# 61
	fadd	f3, f0, f16	# 61
	fsub	f4, f1, f3	# 61
	fadd	f1, f1, f3	# 61
	fdiv	f1, f4, f1	# 61
...
sgn.2544:
	...
	flw		f2, 4(x27)	# 1
	feq		x31, f1, f2	# 1
	beq		x31, x0, feq_else.13223	# 1
	addi	x5, x0, 1	# 1
	jal		x0, feq_cont.13222	# 1
feq_else.13223:
	addi	x5, x0, 0	# 1
feq_cont.13222:
	beq		x5, x4, beq.13224	# 212
	fadd	f1, f0, f2	# 212
	jalr	x0, x1, 0	# 212
beq.13224:
	fle		x31, f1, f2	# 2
	beq		x31, x0, fle_else.13226	# 2
	addi	x5, x0, 0	# 2
	jal		x0, fle_cont.13225	# 2
fle_else.13226:
	addi	x5, x0, 1	# 2
fle_cont.13225:
	beq		x5, x4, beq.13227	# 213
	fadd	f1, f0, f16	# 213
	jalr	x0, x1, 0	# 213
beq.13227:
	fadd	f1, f0, f21	# 214
...
vecunit_sgn.2565:
	...
	fsqrt	f2, f2	# 283
	feq		x31, f2, f1	# 1
	beq		x31, x0, feq_else.13230	# 1
	addi	x9, x0, 1	# 1
	jal		x0, feq_cont.13229	# 1
feq_else.13230:
	addi	x9, x0, 0	# 1
feq_cont.13229:
	beq		x9, x7, beq.13232	# 284
	fadd	f1, f0, f16	# 284
	jal		x0, beq_cont.13231	# 284
beq.13232:
	beq		x5, x7, beq.13234	# 284
	fadd	f1, f0, f21	# 284
	fdiv	f1, f1, f2	# 284
	jal		x0, beq_cont.13233	# 284
beq.13234:
	fadd	f1, f0, f16	# 284
	fdiv	f1, f1, f2	# 284
beq_cont.13233:
...
read_nth_object.2670:
	...
	flw		f2, -32(x2)	# 3
	fle		x31, f2, f1	# 3
	beq		x31, x0, fle_else.13245	# 3
	addi	x4, x0, 0	# 3
	jal		x0, fle_cont.13244	# 3
fle_else.13245:
	addi	x4, x0, 1	# 3
fle_cont.13244:
	lw		x5, -20(x2)	# 798
...
beq_cont.13246:
	lw		x4, -20(x2)	# 819
	lw		x5, -48(x2)	# 819
	beq		x5, x4, beq.13248	# 819
	lw		x4, -68(x2)	# 819
	jal		x0, beq_cont.13247	# 819
beq.13248:
	addi	x4, x0, 1	# 819
beq_cont.13247:
	addi	x6, x0, 4	# 820
	...
	sw		x5, 0(x9)	# 831
	lw		x5, -36(x2)	# 833
	beq		x8, x5, beq.13250	# 833
	addi	x5, x0, 2	# 843
	beq		x8, x5, beq.13252	# 843
	jal		x0, beq_cont.13251	# 843
beq.13252:
	addi	x5, x0, 0	# 845
	lw		x8, -68(x2)	# 845
	beq		x8, x5, beq.13254	# 845
	addi	x5, x0, 0	# 845
	jal		x0, beq_cont.13253	# 845
beq.13254:
	addi	x5, x0, 1	# 845
beq_cont.13253:
	lw		x27, -4(x2)	# 845
...
beq.13250:
	...
	fadd	f2, f0, f0	# 1
	feq		x31, f1, f2	# 1
	beq		x31, x0, feq_else.13256	# 1
	addi	x8, x0, 1	# 1
	jal		x0, feq_cont.13255	# 1
feq_else.13256:
	addi	x8, x0, 0	# 1
feq_cont.13255:
	addi	x9, x0, 0	# 837
	sw		x5, -100(x2)	# 837
	beq		x8, x9, beq.13258	# 837
	fadd	f1, f0, f0	# 837
	jal		x0, beq_cont.13257	# 837
beq.13258:
	lw		x27, -8(x2)	# 837
	fsw		f1, -104(x2)	# 837
	sw		x1, -108(x2)	# 837
...
feq_cont.13259:
	addi	x7, x0, 0	# 839
	sw		x4, -108(x2)	# 839
	beq		x6, x7, beq.13262	# 839
	fadd	f1, f0, f0	# 839
	jal		x0, beq_cont.13261	# 839
beq.13262:
	lw		x27, -8(x2)	# 839
	fsw		f1, -112(x2)	# 839
	sw		x1, -116(x2)	# 839
...
beq_cont.13261:
	...
	fadd	f2, f0, f0	# 1
	feq		x31, f1, f2	# 1
	beq		x31, x0, feq_else.13264	# 1
	addi	x6, x0, 1	# 1
	jal		x0, feq_cont.13263	# 1
feq_else.13264:
	addi	x6, x0, 0	# 1
feq_cont.13263:
	addi	x7, x0, 0	# 841
	sw		x4, -116(x2)	# 841
	beq		x6, x7, beq.13266	# 841
	fadd	f1, f0, f0	# 841
	jal		x0, beq_cont.13265	# 841
beq.13266:
	lw		x27, -8(x2)	# 841
	fsw		f1, -120(x2)	# 841
	sw		x1, -124(x2)	# 841
...
read_object.2672:
	...
	lw		x1, -28(x2)	# 862
	lw		x5, -24(x2)	# 862
	beq		x4, x5, beq.13269	# 862
	lw		x4, -12(x2)	# 863
	lw		x6, -16(x2)	# 863
	add		x6, x6, x4	# 863
	lw		x7, -8(x2)	# 861
	ble		x7, x6, ble.13270	# 861
	lw		x27, -4(x2)	# 862
	sw		x6, -28(x2)	# 862
	addi	x4, x6, 0
	sw		x1, -32(x2)	# 862
...
solver_rect_surface.2684:
	...
	flw		f5, 0(x11)	# 928
	feq		x31, f5, f4	# 1
	beq		x31, x0, feq_else.13284	# 1
	addi	x11, x0, 1	# 1
	jal		x0, feq_cont.13283	# 1
feq_else.13284:
	addi	x11, x0, 0	# 1
feq_cont.13283:
	beq		x11, x10, beq.13285	# 928
	addi	x4, x0, 0	# 928
	jalr	x0, x1, 0	# 928
beq.13285:
	lw		x11, 16(x4)	# 421
	lw		x4, 24(x4)	# 373
	fle		x31, f4, f5	# 3
	beq		x31, x0, fle_else.13287	# 3
	addi	x12, x0, 0	# 3
	jal		x0, fle_cont.13286	# 3
fle_else.13287:
	addi	x12, x0, 1	# 3
fle_cont.13286:
	beq		x4, x10, beq.13289	# 204
	beq		x12, x10, beq.13291	# 204
	addi	x4, x0, 0	# 204
	jal		x0, beq_cont.13290	# 204
beq.13291:
	addi	x4, x0, 1	# 204
beq_cont.13290:
	jal		x0, beq_cont.13288	# 204
beq.13289:
	addi	x4, x12, 0	# 204
beq_cont.13288:
	addi	x12, x0, 4	# 930
	...
	add		x6, x11, x6	# 930
	flw		f6, 0(x6)	# 930
	beq		x4, x10, beq.13293	# 219
	jal		x0, beq_cont.13292	# 219
beq.13293:
	fsub	f6, f0, f6	# 4
beq_cont.13292:
	fsub	f1, f6, f1	# 932
...
fle_cont.13294:
	...
	flw		f5, 0(x4)	# 933
	fle		x31, f5, f2	# 6
	beq		x31, x0, fle_else.13296	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13295	# 6
fle_else.13296:
	addi	x4, x0, 1	# 6
fle_cont.13295:
	beq		x4, x10, beq.13297	# 933
	addi	x4, x0, 4	# 934
	mul		x4, x8, x4	# 934
	add		x4, x5, x4	# 934
	flw		f2, 0(x4)	# 934
...
fle_cont.13298:
	...
	flw		f3, 0(x4)	# 934
	fle		x31, f3, f2	# 6
	beq		x31, x0, fle_else.13300	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13299	# 6
fle_else.13300:
	addi	x4, x0, 1	# 6
fle_cont.13299:
	beq		x4, x10, beq.13301	# 934
	addi	x4, x0, 4	# 935
	mul		x4, x10, x4	# 935
	add		x4, x9, x4	# 935
	fsw		f1, 0(x4)	# 935
...
solver_surface.2699:
	...
	flw		f2, -28(x2)	# 2
	fle		x31, f1, f2	# 2
	beq		x31, x0, fle_else.13306	# 2
	addi	x4, x0, 0	# 2
	jal		x0, fle_cont.13305	# 2
fle_else.13306:
	addi	x4, x0, 1	# 2
fle_cont.13305:
	lw		x5, -24(x2)	# 956
	beq		x4, x5, beq.13307	# 956
	flw		f2, -12(x2)	# 957
	flw		f3, -8(x2)	# 957
	flw		f4, -4(x2)	# 957
	lw		x4, -16(x2)	# 957
...
beq.13312:
	...
	lw		x5, 4(x4)	# 353
	lw		x6, -4(x2)	# 1016
	beq		x5, x6, beq.13314	# 1016
	jal		x0, beq_cont.13313	# 1016
beq.13314:
	fadd	f2, f0, f16	# 1016
	fsub	f1, f1, f2	# 1016
beq_cont.13313:
	...
	flw		f3, -48(x2)	# 2
	fle		x31, f1, f3	# 2
	beq		x31, x0, fle_else.13316	# 2
	addi	x5, x0, 0	# 2
	jal		x0, fle_cont.13315	# 2
fle_else.13316:
	addi	x5, x0, 1	# 2
fle_cont.13315:
	lw		x6, -44(x2)	# 1020
	beq		x5, x6, beq.13317	# 1020
	fsqrt	f1, f1	# 1021
	lw		x4, 24(x4)	# 373
	beq		x4, x6, beq.13319	# 1022
	jal		x0, beq_cont.13318	# 1022
beq.13319:
	fsub	f1, f0, f1	# 4
beq_cont.13318:
	fsub	f1, f1, f2	# 1023
...
solver.2724:
	...
	fsub	f3, f3, f4	# 1036
	lw		x6, 4(x4)	# 353
	beq		x6, x13, beq.13320	# 1039
	beq		x6, x11, beq.13321	# 1040
	addi	x27, x8, 0
	lw		x31, 0(x27)	# 1041
	jalr	x0, x31, 0	# 1041
beq.13321:
...
fle_cont.13322:
	...
	flw		f9, 0(x13)	# 406
	fle		x31, f9, f8	# 6
	beq		x31, x0, fle_else.13324	# 6
	addi	x13, x0, 0	# 6
	jal		x0, fle_cont.13323	# 6
fle_else.13324:
	addi	x13, x0, 1	# 6
fle_cont.13323:
	beq		x13, x11, beq.13326	# 1066
	addi	x13, x0, 4	# 1067
	mul		x13, x9, x13	# 1067
	add		x13, x5, x13	# 1067
	flw		f8, 0(x13)	# 1067
...
fle_cont.13327:
	...
	flw		f9, 0(x13)	# 416
	fle		x31, f9, f8	# 6
	beq		x31, x0, fle_else.13329	# 6
	addi	x13, x0, 0	# 6
	jal		x0, fle_cont.13328	# 6
fle_else.13329:
	addi	x13, x0, 1	# 6
fle_cont.13328:
	beq		x13, x11, beq.13331	# 1067
	feq		x31, f6, f4	# 1
	beq		x31, x0, feq_else.13333	# 1
	addi	x13, x0, 1	# 1
	jal		x0, feq_cont.13332	# 1
feq_else.13333:
	addi	x13, x0, 0	# 1
feq_cont.13332:
	beq		x13, x11, beq.13335	# 1068
	addi	x13, x0, 0	# 1068
	jal		x0, beq_cont.13334	# 1068
beq.13335:
	addi	x13, x0, 1	# 1068
beq_cont.13334:
	jal		x0, beq_cont.13330	# 1067
beq.13331:
	addi	x13, x0, 0	# 1069
beq_cont.13330:
	jal		x0, beq_cont.13325	# 1066
beq.13326:
	addi	x13, x0, 0	# 1070
beq_cont.13325:
	beq		x13, x11, beq.13336	# 1065
	addi	x4, x0, 4	# 1072
	mul		x4, x11, x4	# 1072
	add		x4, x7, x4	# 1072
	fsw		f5, 0(x4)	# 1072
...
fle_cont.13337:
	...
	flw		f10, 0(x10)	# 396
	fle		x31, f10, f9	# 6
	beq		x31, x0, fle_else.13339	# 6
	addi	x10, x0, 0	# 6
	jal		x0, fle_cont.13338	# 6
fle_else.13339:
	addi	x10, x0, 1	# 6
fle_cont.13338:
	beq		x10, x11, beq.13341	# 1075
	addi	x10, x0, 4	# 1076
	mul		x10, x9, x10	# 1076
	add		x5, x5, x10	# 1076
	flw		f9, 0(x5)	# 1076
...
fle_cont.13342:
	...
	flw		f10, 0(x5)	# 416
	fle		x31, f10, f9	# 6
	beq		x31, x0, fle_else.13344	# 6
	addi	x5, x0, 0	# 6
	jal		x0, fle_cont.13343	# 6
fle_else.13344:
	addi	x5, x0, 1	# 6
fle_cont.13343:
	beq		x5, x11, beq.13346	# 1076
	feq		x31, f6, f4	# 1
	beq		x31, x0, feq_else.13348	# 1
	addi	x5, x0, 1	# 1
	jal		x0, feq_cont.13347	# 1
feq_else.13348:
	addi	x5, x0, 0	# 1
feq_cont.13347:
	beq		x5, x11, beq.13350	# 1077
	addi	x5, x0, 0	# 1077
	jal		x0, beq_cont.13349	# 1077
beq.13350:
	addi	x5, x0, 1	# 1077
beq_cont.13349:
	jal		x0, beq_cont.13345	# 1076
beq.13346:
	addi	x5, x0, 0	# 1078
beq_cont.13345:
	jal		x0, beq_cont.13340	# 1075
beq.13341:
	addi	x5, x0, 0	# 1079
beq_cont.13340:
	beq		x5, x11, beq.13351	# 1074
	addi	x4, x0, 4	# 1081
	mul		x4, x11, x4	# 1081
	add		x4, x7, x4	# 1081
	fsw		f5, 0(x4)	# 1081
...
fle_else.13354:
	addi	x5, x0, 1	# 6
fle_cont.13353:
	beq		x5, x11, beq.13356	# 1084
	fmul	f1, f3, f7	# 1085
	fadd	f1, f1, f2	# 1085
	fle		x31, f1, f4	# 5
	beq		x31, x0, fle_cont.13357	# 5
	fsub	f1, f0, f1	# 5
fle_cont.13357:
	lw		x4, 16(x4)	# 401
	addi	x5, x0, 4	# 406
	...
	flw		f2, 0(x4)	# 406
	fle		x31, f2, f1	# 6
	beq		x31, x0, fle_else.13359	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13358	# 6
fle_else.13359:
	addi	x4, x0, 1	# 6
fle_cont.13358:
	beq		x4, x11, beq.13361	# 1085
	feq		x31, f5, f4	# 1
	beq		x31, x0, feq_else.13363	# 1
	addi	x4, x0, 1	# 1
	jal		x0, feq_cont.13362	# 1
feq_else.13363:
	addi	x4, x0, 0	# 1
feq_cont.13362:
	beq		x4, x11, beq.13365	# 1086
	addi	x4, x0, 0	# 1086
	jal		x0, beq_cont.13364	# 1086
beq.13365:
	addi	x4, x0, 1	# 1086
beq_cont.13364:
	jal		x0, beq_cont.13360	# 1085
beq.13361:
	addi	x4, x0, 0	# 1087
beq_cont.13360:
	jal		x0, beq_cont.13355	# 1084
beq.13356:
	addi	x4, x0, 0	# 1088
beq_cont.13355:
	beq		x4, x11, beq.13366	# 1083
	addi	x4, x0, 4	# 1090
	mul		x4, x11, x4	# 1090
	add		x4, x7, x4	# 1090
	fsw		f3, 0(x4)	# 1090
...
solver_surface_fast.2735:
	...
	flw		f5, 0(x10)	# 1097
	fle		x31, f4, f5	# 3
	beq		x31, x0, fle_else.13368	# 3
	addi	x10, x0, 0	# 3
	jal		x0, fle_cont.13367	# 3
fle_else.13368:
	addi	x10, x0, 1	# 3
fle_cont.13367:
	beq		x10, x8, beq.13369	# 1097
	addi	x10, x0, 4	# 1099
	mul		x9, x9, x10	# 1099
	add		x9, x5, x9	# 1099
	flw		f4, 0(x9)	# 1099
...
solver_second_fast.2741:
	...
	flw		f5, 0(x12)	# 1107
	feq		x31, f5, f4	# 1
	beq		x31, x0, feq_else.13371	# 1
	addi	x12, x0, 1	# 1
	jal		x0, feq_cont.13370	# 1
feq_else.13371:
	addi	x12, x0, 0	# 1
feq_cont.13370:
	beq		x12, x10, beq.13372	# 1108
	addi	x4, x0, 0	# 1109
	jalr	x0, x1, 0	# 1109
beq.13372:
	addi	x12, x0, 4	# 1111
	...
	lw		x5, 4(x4)	# 353
	lw		x6, -24(x2)	# 1113
	beq		x5, x6, beq.13374	# 1113
	jal		x0, beq_cont.13373	# 1113
beq.13374:
	fadd	f2, f0, f16	# 1113
	fsub	f1, f1, f2	# 1113
beq_cont.13373:
	...
	flw		f3, -12(x2)	# 2
	fle		x31, f1, f3	# 2
	beq		x31, x0, fle_else.13376	# 2
	addi	x5, x0, 0	# 2
	jal		x0, fle_cont.13375	# 2
fle_else.13376:
	addi	x5, x0, 1	# 2
fle_cont.13375:
	lw		x6, -8(x2)	# 1115
	beq		x5, x6, beq.13377	# 1115
	lw		x4, 24(x4)	# 373
	beq		x4, x6, beq.13379	# 1116
	addi	x4, x0, 0	# 1117
	fsqrt	f1, f1	# 1117
	fadd	f1, f2, f1	# 1117
	addi	x5, x0, 4	# 1117
...
solver_fast.2747:
	...
	lw		x6, 0(x4)	# 1131
	lw		x4, 4(x10)	# 353
	beq		x4, x13, beq.13380	# 1133
	beq		x4, x11, beq.13381	# 1135
	addi	x5, x6, 0
	addi	x4, x10, 0
	addi	x27, x8, 0
	lw		x31, 0(x27)	# 1138
...
solver_surface_fast2.2751:
	...
	flw		f2, 0(x5)	# 1146
	fle		x31, f1, f2	# 3
	beq		x31, x0, fle_else.13383	# 3
	addi	x5, x0, 0	# 3
	jal		x0, fle_cont.13382	# 3
fle_else.13383:
	addi	x5, x0, 1	# 3
fle_cont.13382:
	beq		x5, x8, beq.13384	# 1146
	addi	x5, x0, 4	# 1147
	mul		x5, x7, x5	# 1147
	add		x5, x6, x5	# 1147
	flw		f1, 0(x5)	# 1147
...
solver_second_fast2.2758:
	...
	flw		f5, 0(x12)	# 1155
	feq		x31, f5, f4	# 1
	beq		x31, x0, feq_else.13386	# 1
	addi	x12, x0, 1	# 1
	jal		x0, feq_cont.13385	# 1
feq_else.13386:
	addi	x12, x0, 0	# 1
feq_cont.13385:
	beq		x12, x10, beq.13387	# 1156
	addi	x4, x0, 0	# 1157
	jalr	x0, x1, 0	# 1157
beq.13387:
	addi	x12, x0, 4	# 1159
	...
	fsub	f2, f3, f2	# 1161
	fle		x31, f2, f4	# 2
	beq		x31, x0, fle_else.13389	# 2
	addi	x6, x0, 0	# 2
	jal		x0, fle_cont.13388	# 2
fle_else.13389:
	addi	x6, x0, 1	# 2
fle_cont.13388:
	beq		x6, x10, beq.13390	# 1162
	lw		x4, 24(x4)	# 373
	beq		x4, x10, beq.13392	# 1163
	addi	x4, x0, 0	# 1164
	fsqrt	f2, f2	# 1164
	fadd	f1, f1, f2	# 1164
	addi	x6, x0, 4	# 1164
...
solver_fast2.2765:
	...
	lw		x4, 0(x4)	# 1179
	lw		x11, 4(x9)	# 353
	beq		x11, x12, beq.13393	# 1181
	beq		x11, x10, beq.13394	# 1183
	addi	x6, x13, 0
	addi	x5, x4, 0
	addi	x27, x7, 0
	addi	x4, x9, 0
...
setup_rect_table.2768:
	...
	flw		f2, -12(x2)	# 1
	feq		x31, f1, f2	# 1
	beq		x31, x0, feq_else.13396	# 1
	addi	x5, x0, 1	# 1
	jal		x0, feq_cont.13395	# 1
feq_else.13396:
	addi	x5, x0, 0	# 1
feq_cont.13395:
	beq		x5, x6, beq.13398	# 1197
	addi	x5, x0, 1	# 1198
	fadd	f1, f0, f0	# 1198
	addi	x8, x0, 4	# 1198
	mul		x5, x5, x8	# 1198
...
beq.13398:
	...
	fadd	f3, f0, f0	# 3
	fle		x31, f3, f1	# 3
	beq		x31, x0, fle_else.13400	# 3
	addi	x10, x0, 0	# 3
	jal		x0, fle_cont.13399	# 3
fle_else.13400:
	addi	x10, x0, 1	# 3
fle_cont.13399:
	addi	x11, x0, 0	# 204
	beq		x9, x11, beq.13402	# 204
	beq		x10, x11, beq.13404	# 204
	addi	x9, x0, 0	# 204
	jal		x0, beq_cont.13403	# 204
beq.13404:
	addi	x9, x0, 1	# 204
beq_cont.13403:
	jal		x0, beq_cont.13401	# 204
beq.13402:
	addi	x9, x10, 0	# 204
beq_cont.13401:
	lw		x10, 16(x8)	# 391
	...
	flw		f1, 0(x10)	# 396
	addi	x10, x0, 0	# 219
	beq		x9, x10, beq.13406	# 219
	jal		x0, beq_cont.13405	# 219
beq.13406:
	fsub	f1, f0, f1	# 4
beq_cont.13405:
	addi	x9, x0, 4	# 1201
...
beq_cont.13397:
	...
	flw		f1, 0(x5)	# 1205
	feq		x31, f1, f2	# 1
	beq		x31, x0, feq_else.13408	# 1
	addi	x5, x0, 1	# 1
	jal		x0, feq_cont.13407	# 1
feq_else.13408:
	addi	x5, x0, 0	# 1
feq_cont.13407:
	beq		x5, x6, beq.13410	# 1205
	addi	x5, x0, 3	# 1206
	fadd	f1, f0, f0	# 1206
	addi	x8, x0, 4	# 1206
	mul		x5, x5, x8	# 1206
...
beq.13410:
	...
	fadd	f3, f0, f0	# 3
	fle		x31, f3, f1	# 3
	beq		x31, x0, fle_else.13412	# 3
	addi	x10, x0, 0	# 3
	jal		x0, fle_cont.13411	# 3
fle_else.13412:
	addi	x10, x0, 1	# 3
fle_cont.13411:
	addi	x11, x0, 0	# 204
	beq		x9, x11, beq.13414	# 204
	beq		x10, x11, beq.13416	# 204
	addi	x9, x0, 0	# 204
	jal		x0, beq_cont.13415	# 204
beq.13416:
	addi	x9, x0, 1	# 204
beq_cont.13415:
	jal		x0, beq_cont.13413	# 204
beq.13414:
	addi	x9, x10, 0	# 204
beq_cont.13413:
	lw		x10, 16(x8)	# 401
	...
	flw		f1, 0(x10)	# 406
	addi	x10, x0, 0	# 219
	beq		x9, x10, beq.13418	# 219
	jal		x0, beq_cont.13417	# 219
beq.13418:
	fsub	f1, f0, f1	# 4
beq_cont.13417:
	addi	x9, x0, 4	# 1208
...
beq.13422:
	...
	fadd	f2, f0, f0	# 3
	fle		x31, f2, f1	# 3
	beq		x31, x0, fle_else.13424	# 3
	addi	x9, x0, 0	# 3
	jal		x0, fle_cont.13423	# 3
fle_else.13424:
	addi	x9, x0, 1	# 3
fle_cont.13423:
	addi	x10, x0, 0	# 204
	beq		x8, x10, beq.13426	# 204
	beq		x9, x10, beq.13428	# 204
	addi	x8, x0, 0	# 204
	jal		x0, beq_cont.13427	# 204
beq.13428:
	addi	x8, x0, 1	# 204
beq_cont.13427:
	jal		x0, beq_cont.13425	# 204
beq.13426:
	addi	x8, x9, 0	# 204
beq_cont.13425:
	lw		x6, 16(x6)	# 411
	...
	flw		f1, 0(x6)	# 416
	addi	x6, x0, 0	# 219
	beq		x8, x6, beq.13430	# 219
	jal		x0, beq_cont.13429	# 219
beq.13430:
	fsub	f1, f0, f1	# 4
beq_cont.13429:
	addi	x6, x0, 4	# 1214
...
setup_surface_table.2771:
	...
	flw		f2, 0(x2)	# 2
	fle		x31, f1, f2	# 2
	beq		x31, x0, fle_else.13432	# 2
	addi	x7, x0, 0	# 2
	jal		x0, fle_cont.13431	# 2
fle_else.13432:
	addi	x7, x0, 1	# 2
fle_cont.13431:
	beq		x7, x6, beq.13434	# 1226
	addi	x6, x0, 0	# 1228
	fadd	f2, f0, f21	# 1228
	fdiv	f2, f2, f1	# 1228
	addi	x7, x0, 4	# 1228
...
beq_cont.13435:
	flw		f2, 0(x2)	# 1
	feq		x31, f1, f2	# 1
	beq		x31, x0, feq_else.13438	# 1
	addi	x4, x0, 1	# 1
	jal		x0, feq_cont.13437	# 1
feq_else.13438:
	addi	x4, x0, 0	# 1
feq_cont.13437:
	beq		x4, x5, beq.13440	# 1261
	jal		x0, beq_cont.13439	# 1261
beq.13440:
	addi	x4, x0, 4	# 1262
	fadd	f2, f0, f16	# 1262
	fdiv	f1, f2, f1	# 1262
...
ble.13441:
	...
	sw		x27, -4(x2)	# 1275
	sw		x11, -8(x2)	# 1275
	beq		x13, x11, beq.13444	# 1275
	addi	x8, x0, 2	# 1277
	beq		x13, x8, beq.13446	# 1277
	sw		x10, -12(x2)	# 1280
	sw		x5, -16(x2)	# 1280
	addi	x5, x9, 0
	addi	x4, x12, 0
...
ble.13447:
	...
	sw		x11, -8(x2)	# 1302
	sw		x5, -12(x2)	# 1302
	beq		x13, x9, beq.13450	# 1302
	addi	x6, x0, 2	# 1305
	ble		x13, x6, ble_cont.13451	# 1305
	addi	x6, x0, 0	# 1306
	addi	x9, x0, 4	# 1306
	mul		x6, x6, x9	# 1306
	add		x6, x12, x6	# 1306
	...
	addi	x5, x0, 3	# 1307
	lw		x6, -20(x2)	# 1307
	beq		x6, x5, beq.13453	# 1307
	jal		x0, beq_cont.13452	# 1307
beq.13453:
	fadd	f2, f0, f16	# 1307
	fsub	f1, f1, f2	# 1307
beq_cont.13452:
...
fle_cont.13454:
	...
	flw		f5, 0(x8)	# 396
	fle		x31, f5, f1	# 6
	beq		x31, x0, fle_else.13456	# 6
	addi	x8, x0, 0	# 6
	jal		x0, fle_cont.13455	# 6
fle_else.13456:
	addi	x8, x0, 1	# 6
fle_cont.13455:
	beq		x8, x6, beq.13458	# 1327
	fle		x31, f2, f4	# 5
	beq		x31, x0, fle_else.13460	# 5
	fsub	f1, f0, f2	# 5
	jal		x0, fle_cont.13459	# 5
fle_else.13460:
	fadd	f1, f0, f2	# 5
fle_cont.13459:
	lw		x8, 16(x4)	# 401
...
fle_else.13462:
	addi	x7, x0, 1	# 6
fle_cont.13461:
	beq		x7, x6, beq.13464	# 1328
	fle		x31, f3, f4	# 5
	beq		x31, x0, fle_else.13466	# 5
	fsub	f1, f0, f3	# 5
	jal		x0, fle_cont.13465	# 5
fle_else.13466:
	fadd	f1, f0, f3	# 5
fle_cont.13465:
	lw		x7, 16(x4)	# 411
	...
	flw		f2, 0(x5)	# 416
	fle		x31, f2, f1	# 6
	beq		x31, x0, fle_else.13468	# 6
	addi	x5, x0, 0	# 6
	jal		x0, fle_cont.13467	# 6
fle_else.13468:
	addi	x5, x0, 1	# 6
fle_cont.13467:
	jal		x0, beq_cont.13463	# 1328
beq.13464:
	addi	x5, x0, 0	# 1330
beq_cont.13463:
	jal		x0, beq_cont.13457	# 1327
beq.13458:
	addi	x5, x0, 0	# 1331
beq_cont.13457:
	beq		x5, x6, beq.13469	# 1326
	lw		x4, 24(x4)	# 373
	jalr	x0, x1, 0	# 377
beq.13469:
	lw		x4, 24(x4)	# 373
	beq		x4, x6, beq.13470	# 1332
	addi	x4, x0, 0	# 1332
	jalr	x0, x1, 0	# 1332
beq.13470:
	addi	x4, x0, 1	# 1332
...
is_plane_outside.2792:
	...
	flw		f2, -4(x2)	# 3
	fle		x31, f2, f1	# 3
	beq		x31, x0, fle_else.13472	# 3
	addi	x5, x0, 0	# 3
	jal		x0, fle_cont.13471	# 3
fle_else.13472:
	addi	x5, x0, 1	# 3
fle_cont.13471:
	lw		x6, 0(x2)	# 204
	beq		x4, x6, beq.13474	# 204
	beq		x5, x6, beq.13476	# 204
	addi	x4, x0, 0	# 204
	jal		x0, beq_cont.13475	# 204
beq.13476:
	addi	x4, x0, 1	# 204
beq_cont.13475:
	jal		x0, beq_cont.13473	# 204
beq.13474:
	addi	x4, x5, 0	# 204
beq_cont.13473:
	beq		x4, x6, beq.13477	# 1338
	addi	x4, x0, 0	# 1338
	jalr	x0, x1, 0	# 1338
beq.13477:
	addi	x4, x0, 1	# 1338
...
is_second_outside.2797:
	...
	lw		x5, 4(x4)	# 353
	lw		x6, -8(x2)	# 1344
	beq		x5, x6, beq.13479	# 1344
	jal		x0, beq_cont.13478	# 1344
beq.13479:
	fadd	f2, f0, f16	# 1344
	fsub	f1, f1, f2	# 1344
beq_cont.13478:
	...
	flw		f2, -4(x2)	# 3
	fle		x31, f2, f1	# 3
	beq		x31, x0, fle_else.13481	# 3
	addi	x5, x0, 0	# 3
	jal		x0, fle_cont.13480	# 3
fle_else.13481:
	addi	x5, x0, 1	# 3
fle_cont.13480:
	lw		x6, 0(x2)	# 204
	beq		x4, x6, beq.13483	# 204
	beq		x5, x6, beq.13485	# 204
	addi	x4, x0, 0	# 204
	jal		x0, beq_cont.13484	# 204
beq.13485:
	addi	x4, x0, 1	# 204
beq_cont.13484:
...
is_outside.2802:
	...
	fsub	f3, f3, f4	# 1352
	lw		x9, 4(x4)	# 353
	beq		x9, x10, beq.13487	# 1354
	beq		x9, x8, beq.13488	# 1356
	addi	x27, x5, 0
	lw		x31, 0(x27)	# 1359
	jalr	x0, x31, 0	# 1359
beq.13488:
...
shadow_check_and_group.2813:
	...
	add		x5, x7, x5	# 1389
	flw		f1, 0(x5)	# 1389
	beq		x4, x6, beq.13493	# 1390
	lui		x4, %hi(l.9220)	# 1390
	ori		x4, x0, %lo(l.9220)	# 1390
	flw		f2, 0(x4)	# 1390
	fle		x31, f2, f1	# 6
	beq		x31, x0, fle_else.13495	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13494	# 6
fle_else.13495:
	addi	x4, x0, 1	# 6
fle_cont.13494:
	jal		x0, beq_cont.13492	# 1390
beq.13493:
	addi	x4, x0, 0	# 1390
beq_cont.13492:
	beq		x4, x6, beq.13496	# 1390
	fadd	f2, f0, f23	# 1393
	fadd	f1, f1, f2	# 1393
	addi	x4, x0, 4	# 1394
	mul		x4, x6, x4	# 1394
...
shadow_check_one_or_matrix.2819:
	...
	fadd	f2, f0, f22	# 1442
	fle		x31, f2, f1	# 6
	beq		x31, x0, fle_else.13507	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13506	# 6
fle_else.13507:
	addi	x4, x0, 1	# 6
fle_cont.13506:
	addi	x5, x0, 0	# 1442
	beq		x4, x5, beq.13509	# 1442
	addi	x4, x0, 1	# 1443
	lw		x5, 0(x2)	# 1443
	lw		x27, -4(x2)	# 1443
	sw		x1, -32(x2)	# 1443
	...
	lw		x1, -32(x2)	# 1443
	addi	x5, x0, 0	# 1443
	beq		x4, x5, beq.13511	# 1443
	addi	x4, x0, 1	# 1444
	jal		x0, beq_cont.13510	# 1443
beq.13511:
	addi	x4, x0, 0	# 1445
beq_cont.13510:
	jal		x0, beq_cont.13508	# 1442
beq.13509:
	addi	x4, x0, 0	# 1446
beq_cont.13508:
	jal		x0, beq_cont.13504	# 1441
beq.13505:
	addi	x4, x0, 0	# 1447
beq_cont.13504:
	jal		x0, beq_cont.13502	# 1435
beq.13503:
	addi	x4, x0, 1	# 1436
beq_cont.13502:
	lw		x5, -24(x2)	# 1434
	beq		x4, x5, beq.13512	# 1434
	lw		x4, -16(x2)	# 1449
	lw		x6, 0(x2)	# 1449
	lw		x27, -4(x2)	# 1449
	addi	x5, x6, 0
...
fle_cont.13516:
	...
	flw		f2, 0(x6)	# 1476
	fle		x31, f2, f1	# 6
	beq		x31, x0, fle_else.13520	# 6
	addi	x6, x0, 0	# 6
	jal		x0, fle_cont.13519	# 6
fle_else.13520:
	addi	x6, x0, 1	# 6
fle_cont.13519:
	addi	x8, x0, 0	# 1476
	beq		x6, x8, beq_cont.13521	# 1476
	fadd	f2, f0, f23	# 1478
	fadd	f1, f1, f2	# 1478
	addi	x6, x0, 0	# 1479
	addi	x8, x0, 4	# 1479
...
trace_or_matrix.2830:
	...
	flw		f2, 0(x4)	# 1529
	fle		x31, f2, f1	# 6
	beq		x31, x0, fle_else.13533	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13532	# 6
fle_else.13533:
	addi	x4, x0, 1	# 6
fle_cont.13532:
	addi	x5, x0, 0	# 1529
	beq		x4, x5, beq_cont.13534	# 1529
	addi	x4, x0, 1	# 1530
	lw		x5, -20(x2)	# 1530
	lw		x6, 0(x2)	# 1530
	lw		x27, -24(x2)	# 1530
...
judge_intersection.2834:
	...
	fadd	f2, f0, f22	# 1547
	fle		x31, f1, f2	# 6
	beq		x31, x0, fle_else.13537	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13536	# 6
fle_else.13537:
	addi	x4, x0, 1	# 6
fle_cont.13536:
	beq		x4, x5, beq.13538	# 1547
	fadd	f2, f0, f26	# 1548
	fle		x31, f2, f1	# 6
	beq		x31, x0, fle_else.13539	# 6
	addi	x4, x0, 0	# 6
	jalr	x0, x1, 0	# 6
fle_else.13539:
	addi	x4, x0, 1	# 6
...
solve_each_element_fast.2836:
	...
	flw		f2, -32(x2)	# 6
	fle		x31, f1, f2	# 6
	beq		x31, x0, fle_else.13543	# 6
	addi	x6, x0, 0	# 6
	jal		x0, fle_cont.13542	# 6
fle_else.13543:
	addi	x6, x0, 1	# 6
fle_cont.13542:
	beq		x6, x5, beq_cont.13544	# 1569
	addi	x6, x0, 0	# 1570
	addi	x7, x0, 4	# 1570
	mul		x6, x6, x7	# 1570
	lw		x7, -28(x2)	# 1570
	...
	flw		f2, 0(x6)	# 1570
	fle		x31, f2, f1	# 6
	beq		x31, x0, fle_else.13546	# 6
	addi	x6, x0, 0	# 6
	jal		x0, fle_cont.13545	# 6
fle_else.13546:
	addi	x6, x0, 1	# 6
fle_cont.13545:
	addi	x8, x0, 0	# 1570
	beq		x6, x8, beq_cont.13547	# 1570
	fadd	f2, f0, f23	# 1572
	fadd	f1, f1, f2	# 1572
	addi	x6, x0, 0	# 1573
	addi	x8, x0, 4	# 1573
...
trace_or_matrix_fast.2844:
	...
	flw		f2, 0(x4)	# 1622
	fle		x31, f2, f1	# 6
	beq		x31, x0, fle_else.13559	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13558	# 6
fle_else.13559:
	addi	x4, x0, 1	# 6
fle_cont.13558:
	addi	x5, x0, 0	# 1622
	beq		x4, x5, beq_cont.13560	# 1622
	addi	x4, x0, 1	# 1623
	lw		x5, -20(x2)	# 1623
	lw		x6, 0(x2)	# 1623
	lw		x27, -24(x2)	# 1623
...
judge_intersection_fast.2848:
	...
	fadd	f2, f0, f22	# 1638
	fle		x31, f1, f2	# 6
	beq		x31, x0, fle_else.13563	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13562	# 6
fle_else.13563:
	addi	x4, x0, 1	# 6
fle_cont.13562:
	beq		x4, x5, beq.13564	# 1638
	fadd	f2, f0, f26	# 1639
	fle		x31, f2, f1	# 6
...
utexture.2859:
	...
	add		x15, x6, x15	# 1712
	fsw		f3, 0(x15)	# 1712
	beq		x14, x13, beq.13570	# 1713
	beq		x14, x10, beq.13571	# 1731
	beq		x14, x11, beq.13572	# 1738
	addi	x7, x0, 4	# 1749
	beq		x14, x7, beq.13573	# 1749
	jalr	x0, x1, 0	# 1777
beq.13573:
	addi	x7, x0, 4	# 1751
	mul		x7, x12, x7	# 1751
	...
	fadd	f5, f5, f6	# 1753
	fle		x31, f3, f2	# 5
	beq		x31, x0, fle_else.13576	# 5
	fsub	f6, f0, f3	# 5
	jal		x0, fle_cont.13575	# 5
fle_else.13576:
	fadd	f6, f0, f3	# 5
fle_cont.13575:
	lui		x7, %hi(l.9557)	# 1755
	ori		x7, x0, %lo(l.9557)	# 1755
	flw		f7, 0(x7)	# 1755
	fle		x31, f7, f6	# 6
	beq		x31, x0, fle_else.13578	# 6
	addi	x7, x0, 0	# 6
	jal		x0, fle_cont.13577	# 6
fle_else.13578:
	addi	x7, x0, 1	# 6
fle_cont.13577:
	sw		x6, 0(x2)	# 1755
	...
	sw		x5, -36(x2)	# 1755
	sw		x13, -40(x2)	# 1755
	beq		x7, x12, beq.13580	# 1755
	fadd	f1, f0, f25	# 1756
	jal		x0, beq_cont.13579	# 1755
beq.13580:
	fdiv	f3, f4, f3	# 1758
	fadd	f4, f0, f0	# 5
	fle		x31, f3, f4	# 5
	beq		x31, x0, fle_cont.13581	# 5
	fsub	f3, f0, f3	# 5
fle_cont.13581:
	addi	x27, x9, 0
	fadd	f1, f0, f3
...
beq_cont.13579:
	...
	flw		f4, -28(x2)	# 5
	fle		x31, f4, f3	# 5
	beq		x31, x0, fle_else.13583	# 5
	fsub	f5, f0, f4	# 5
	jal		x0, fle_cont.13582	# 5
fle_else.13583:
	fadd	f5, f0, f4	# 5
fle_cont.13582:
	flw		f6, -20(x2)	# 6
	fle		x31, f6, f5	# 6
	beq		x31, x0, fle_else.13585	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13584	# 6
fle_else.13585:
	addi	x4, x0, 1	# 6
fle_cont.13584:
	lw		x5, -16(x2)	# 1766
	fsw		f1, -48(x2)	# 1766
	beq		x4, x5, beq.13587	# 1766
	fadd	f1, f0, f25	# 1767
	jal		x0, beq_cont.13586	# 1766
beq.13587:
	fdiv	f2, f2, f4	# 1769
	fadd	f4, f0, f0	# 5
	fle		x31, f2, f4	# 5
	beq		x31, x0, fle_cont.13588	# 5
	fsub	f2, f0, f2	# 5
fle_cont.13588:
	lw		x27, -12(x2)	# 1770
	fadd	f1, f0, f2
...
beq_cont.13586:
	...
	flw		f2, -24(x2)	# 3
	fle		x31, f2, f1	# 3
	beq		x31, x0, fle_else.13590	# 3
	addi	x4, x0, 0	# 3
	jal		x0, fle_cont.13589	# 3
fle_else.13590:
	addi	x4, x0, 1	# 3
fle_cont.13589:
	lw		x5, -16(x2)	# 1774
	beq		x4, x5, beq_cont.13591	# 1774
	fadd	f1, f0, f2	# 1774
beq_cont.13591:
	flw		f2, -8(x2)	# 1775
	fmul	f1, f2, f1	# 1775
...
beq.13570:
	...
	fadd	f3, f0, f27	# 1719
	fle		x31, f3, f1	# 6
	beq		x31, x0, fle_else.13596	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13595	# 6
fle_else.13596:
	addi	x4, x0, 1	# 6
fle_cont.13595:
	addi	x5, x0, 4	# 1721
...
fle_cont.13597:
	lw		x5, -16(x2)	# 1727
	lw		x6, -72(x2)	# 1727
	beq		x6, x5, beq.13600	# 1727
	beq		x4, x5, beq.13602	# 1728
	flw		f1, -8(x2)	# 1728
	jal		x0, beq_cont.13601	# 1728
beq.13602:
	flw		f1, -24(x2)	# 1728
beq_cont.13601:
	jal		x0, beq_cont.13599	# 1727
beq.13600:
	beq		x4, x5, beq.13604	# 1729
	flw		f1, -24(x2)	# 1729
	jal		x0, beq_cont.13603	# 1729
beq.13604:
	flw		f1, -8(x2)	# 1729
beq_cont.13603:
beq_cont.13599:
...
fle_cont.13606:
	...
	fsw		f4, -20(x2)	# 1788
	fsw		f2, -24(x2)	# 1788
	beq		x10, x8, beq_cont.13608	# 1788
	addi	x27, x4, 0
	addi	x4, x6, 0
	sw		x1, -28(x2)	# 1789
	addi	x2, x2, -32	# 1789
...
beq_cont.13608:
	...
	flw		f2, -24(x2)	# 2
	fle		x31, f2, f1	# 2
	beq		x31, x0, fle_else.13610	# 2
	addi	x4, x0, 0	# 2
	jal		x0, fle_cont.13609	# 2
fle_else.13610:
	addi	x4, x0, 1	# 2
fle_cont.13609:
	lw		x5, -16(x2)	# 1793
	beq		x4, x5, beq.13611	# 1793
	fmul	f1, f2, f2	# 8
	fmul	f1, f1, f1	# 8
	flw		f2, -12(x2)	# 1794
	fmul	f1, f1, f2	# 1794
...
ble.13614:
	...
	lw		x5, -48(x2)	# 655
	lw		x6, 0(x5)	# 655
	beq		x4, x6, beq.13618	# 1811
	jal		x0, beq_cont.13617	# 1811
beq.13618:
	addi	x4, x0, 0	# 1813
	addi	x6, x0, 0	# 1813
	addi	x7, x0, 4	# 1813
	...
	lw		x1, -64(x2)	# 1813
	addi	x5, x0, 0	# 1813
	beq		x4, x5, beq.13620	# 1813
	jal		x0, beq_cont.13619	# 1813
beq.13620:
	lw		x4, -36(x2)	# 639
	lw		x5, 0(x4)	# 639
	lw		x6, -28(x2)	# 1815
...
ble.13621:
	...
	sw		x4, -168(x2)	# 1693
	sw		x6, -172(x2)	# 1693
	beq		x8, x9, beq.13625	# 1693
	lw		x10, -108(x2)	# 1695
	beq		x8, x10, beq.13627	# 1695
	lw		x27, -88(x2)	# 1698
	addi	x4, x6, 0
	sw		x1, -176(x2)	# 1698
	addi	x2, x2, -180	# 1698
...
beq_cont.13624:
	...
	fadd	f2, f0, f17	# 1852
	fle		x31, f2, f1	# 6
	beq		x31, x0, fle_else.13629	# 6
	addi	x7, x0, 0	# 6
	jal		x0, fle_cont.13628	# 6
fle_else.13629:
	addi	x7, x0, 1	# 6
fle_cont.13628:
	beq		x7, x9, beq.13631	# 1852
	addi	x7, x0, 0	# 1853
	addi	x8, x0, 4	# 1853
	lw		x10, -152(x2)	# 1853
	mul		x8, x10, x8	# 1853
...
beq_cont.13630:
	...
	lw		x1, -188(x2)	# 1870
	lw		x5, -156(x2)	# 1870
	beq		x4, x5, beq.13633	# 1870
	jal		x0, beq_cont.13632	# 1870
beq.13633:
	lw		x4, -40(x2)	# 1871
	lw		x6, -132(x2)	# 1871
	lw		x27, -140(x2)	# 1871
...
beq_cont.13632:
	...
	flw		f2, -124(x2)	# 6
	fle		x31, f2, f1	# 6
	beq		x31, x0, fle_else.13635	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13634	# 6
fle_else.13635:
	addi	x4, x0, 1	# 6
fle_cont.13634:
	lw		x5, -156(x2)	# 1881
	beq		x4, x5, beq.13636	# 1881
	lw		x4, -152(x2)	# 1883
	lw		x6, -68(x2)	# 1883
	ble		x6, x4, ble_cont.13637	# 1883
	addi	x6, x4, 1	# 1884
	addi	x7, x0, -1	# 1884
	addi	x8, x0, 4	# 1884
	mul		x6, x6, x8	# 1884
...
beq.13623:
	...
	flw		f2, -128(x2)	# 2
	fle		x31, f1, f2	# 2
	beq		x31, x0, fle_else.13643	# 2
	addi	x4, x0, 0	# 2
	jal		x0, fle_cont.13642	# 2
fle_else.13643:
	addi	x4, x0, 1	# 2
fle_cont.13642:
	lw		x5, -156(x2)	# 1902
	beq		x4, x5, beq.13644	# 1902
	fmul	f2, f1, f1	# 8
	fmul	f1, f2, f1	# 1905
	flw		f2, -124(x2)	# 1905
	fmul	f1, f1, f2	# 1905
...
trace_diffuse_ray.2877:
	...
	lw		x8, -64(x2)	# 1693
	sw		x4, -84(x2)	# 1693
	beq		x7, x8, beq.13650	# 1693
	lw		x6, -56(x2)	# 1695
	beq		x7, x6, beq.13652	# 1695
	lw		x27, -48(x2)	# 1698
	sw		x1, -88(x2)	# 1698
	addi	x2, x2, -92	# 1698
	lw		x31, 0(x27)	# 1698
...
beq.13653:
	...
	flw		f2, -16(x2)	# 2
	fle		x31, f1, f2	# 2
	beq		x31, x0, fle_else.13656	# 2
	addi	x4, x0, 0	# 2
	jal		x0, fle_cont.13655	# 2
fle_else.13656:
	addi	x4, x0, 1	# 2
fle_cont.13655:
	lw		x5, -80(x2)	# 1935
	beq		x4, x5, beq.13658	# 1935
	jal		x0, beq_cont.13657	# 1935
beq.13658:
	fadd	f1, f0, f2	# 1935
beq_cont.13657:
	flw		f2, -12(x2)	# 1936
...
ble.13660:
	...
	flw		f2, -32(x2)	# 3
	fle		x31, f2, f1	# 3
	beq		x31, x0, fle_else.13663	# 3
	addi	x4, x0, 0	# 3
	jal		x0, fle_cont.13662	# 3
fle_else.13663:
	addi	x4, x0, 1	# 3
fle_cont.13662:
	lw		x5, -28(x2)	# 1949
	beq		x4, x5, beq.13665	# 1949
	lw		x4, -24(x2)	# 1950
	addi	x5, x4, 1	# 1950
	addi	x6, x0, 4	# 1950
	mul		x5, x5, x6	# 1950
...
trace_diffuse_ray_80percent.2889:
	...
	sw		x16, -44(x2)	# 1971
	sw		x4, -48(x2)	# 1971
	beq		x4, x15, beq_cont.13666	# 1971
	addi	x17, x0, 0	# 1972
	addi	x18, x0, 4	# 1972
...
neighbors_exist.2905:
	...
	lw		x9, 0(x9)	# 2050
	add		x10, x5, x8	# 2050
	ble		x9, x10, ble.13677	# 2050
	ble		x5, x7, ble.13678	# 2051
	addi	x5, x0, 4	# 2052
	mul		x5, x7, x5	# 2052
	add		x5, x6, x5	# 2052
	lw		x5, 0(x5)	# 2052
	add		x6, x4, x8	# 2052
	ble		x5, x6, ble.13679	# 2052
	ble		x4, x7, ble.13680	# 2053
	addi	x4, x0, 1	# 2054
	jalr	x0, x1, 0	# 2054
ble.13680:
	addi	x4, x0, 0	# 2055
...
write_rgb_element_int.2927:
	...
	lw		x1, -4(x2)	# 2128
	addi	x5, x0, 255	# 2129
	ble		x4, x5, ble.13692	# 2129
	addi	x4, x0, 255	# 2129
	jal		x0, ble_cont.13691	# 2129
ble.13692:
	lw		x5, 0(x2)	# 2129
	ble		x5, x4, ble_cont.13693	# 2129
	addi	x4, x0, 0	# 2129
ble_cont.13693:
ble_cont.13691:
...
write_rgb_element_char.2929:
	...
	lw		x1, -4(x2)	# 2134
	addi	x5, x0, 255	# 2135
	ble		x4, x5, ble.13695	# 2135
	addi	x4, x0, 255	# 2135
	jal		x0, ble_cont.13694	# 2135
ble.13695:
	lw		x5, 0(x2)	# 2135
	ble		x5, x4, ble_cont.13696	# 2135
	addi	x4, x0, 0	# 2135
ble_cont.13696:
ble_cont.13694:
...
ble.13700:
	...
	sw		x15, -8(x2)	# 2170
	sw		x5, -12(x2)	# 2170
	beq		x16, x14, beq_cont.13702	# 2170
	lw		x16, 24(x4)	# 614
	addi	x17, x0, 0	# 616
	addi	x18, x0, 4	# 616
	mul		x17, x17, x18	# 616
...
ble.13703:
	...
	add		x4, x6, x4	# 224
	lw		x6, -4(x2)	# 225
	ble		x6, x4, ble.13706	# 225
	addi	x6, x4, 0	# 225
	jal		x0, ble_cont.13705	# 225
ble.13706:
	sub		x6, x4, x6	# 225
ble_cont.13705:
	flw		f1, -72(x2)	# 2211
...
scan_line.2954:
	...
	sw		x15, -40(x2)	# 2257
	sw		x10, -44(x2)	# 2257
	ble		x12, x4, ble_cont.13712	# 2257
	addi	x12, x4, 1	# 2258
	addi	x6, x8, 0
	addi	x5, x12, 0
	addi	x4, x7, 0
...
ble_cont.13712:
	...
	add		x5, x6, x5	# 224
	lw		x6, -4(x2)	# 225
	ble		x6, x5, ble.13714	# 225
	addi	x8, x5, 0	# 225
	jal		x0, ble_cont.13713	# 225
ble.13714:
	sub		x8, x5, x6	# 225
ble_cont.13713:
	lw		x5, -28(x2)	# 2261
...
ble.13719:
	...
	add		x4, x6, x4	# 224
	lw		x6, -4(x2)	# 225
	ble		x6, x4, ble.13722	# 225
	jal		x0, ble_cont.13721	# 225
ble.13722:
	sub		x4, x4, x6	# 225
ble_cont.13721:
	flw		f1, -20(x2)	# 2363
...
ble.13723:
	...
	add		x5, x6, x5	# 224
	lw		x6, -4(x2)	# 225
	ble		x6, x5, ble.13726	# 225
	jal		x0, ble_cont.13725	# 225
ble.13726:
	sub		x5, x5, x6	# 225
ble_cont.13725:
	lw		x6, -20(x2)	# 2372
...
beq.13740:
	...
	fadd	f2, f0, f16	# 2473
	fle		x31, f2, f1	# 6
	beq		x31, x0, fle_else.13743	# 6
	addi	x11, x0, 0	# 6
	jal		x0, fle_cont.13742	# 6
fle_else.13743:
	addi	x11, x0, 1	# 6
fle_cont.13742:
	beq		x11, x9, beq.13744	# 2473
	lw		x9, 4(x7)	# 353
	beq		x9, x10, beq.13745	# 2476
	beq		x9, x8, beq.13746	# 2478
	jalr	x0, x1, 0	# 2480
beq.13746:
	addi	x27, x5, 0
	addi	x5, x7, 0
