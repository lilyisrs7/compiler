...
beq_cont.13304:
	lw		x4, -20(x2)	# 819
	lw		x5, -52(x2)	# 819
	beq		x5, x4, beq.13306	# 819
	lw		x4, -72(x2)	# 819
	jal		x0, beq_cont.13305	# 819
beq.13306:
	addi	x4, x0, 1	# 819
beq_cont.13305:
	addi	x6, x0, 4	# 820
	...
	sw		x5, 0(x9)	# 831
	lw		x5, -40(x2)	# 833
	beq		x8, x5, beq.13308	# 833
	addi	x5, x0, 2	# 843
	beq		x8, x5, beq.13310	# 843
	jal		x0, beq_cont.13309	# 843
beq.13310:
	addi	x5, x0, 0	# 845
	lw		x8, -72(x2)	# 845
	beq		x8, x5, beq.13312	# 845
	addi	x5, x0, 0	# 845
	jal		x0, beq_cont.13311	# 845
beq.13312:
	addi	x5, x0, 1	# 845
beq_cont.13311:
	lw		x27, -4(x2)	# 845
...
beq.13308:
	...
	flw		f1, 0(x8)	# 1
	feq		x31, f0, f1	# 1
	beq		x31, x0, feq_else.13314	# 1
	addi	x8, x0, 1	# 1
	jal		x0, feq_cont.13313	# 1
feq_else.13314:
	addi	x8, x0, 0	# 1
feq_cont.13313:
	addi	x9, x0, 0	# 837
	sw		x5, -104(x2)	# 837
	beq		x8, x9, beq.13316	# 837
	lui		x8, %hi(l.8174)	# 837
	ori		x8, x0, %lo(l.8174)	# 837
	flw		f0, 0(x8)	# 837
	jal		x0, beq_cont.13315	# 837
beq.13316:
	lw		x27, -8(x2)	# 837
	fsw		f0, -112(x2)	# 837
	sw		x1, -120(x2)	# 837
...
feq_cont.13318:
	addi	x7, x0, 0	# 839
	sw		x4, -120(x2)	# 839
	beq		x6, x7, beq.13321	# 839
	lui		x6, %hi(l.8174)	# 839
	ori		x6, x0, %lo(l.8174)	# 839
	flw		f0, 0(x6)	# 839
	jal		x0, beq_cont.13320	# 839
beq.13321:
	lw		x27, -8(x2)	# 839
	fsw		f0, -128(x2)	# 839
	sw		x1, -136(x2)	# 839
...
beq_cont.13320:
	...
	flw		f1, 0(x6)	# 1
	feq		x31, f0, f1	# 1
	beq		x31, x0, feq_else.13324	# 1
	addi	x6, x0, 1	# 1
	jal		x0, feq_cont.13323	# 1
feq_else.13324:
	addi	x6, x0, 0	# 1
feq_cont.13323:
	addi	x7, x0, 0	# 841
	sw		x4, -136(x2)	# 841
	beq		x6, x7, beq.13326	# 841
	lui		x6, %hi(l.8174)	# 841
	ori		x6, x0, %lo(l.8174)	# 841
	flw		f0, 0(x6)	# 841
	jal		x0, beq_cont.13325	# 841
beq.13326:
	lw		x27, -8(x2)	# 841
	fsw		f0, -144(x2)	# 841
	sw		x1, -152(x2)	# 841
...
read_object.2672:
	...
	lw		x1, -28(x2)	# 862
	lw		x5, -24(x2)	# 862
	beq		x4, x5, beq.13330	# 862
	lw		x4, -12(x2)	# 863
	lw		x6, -16(x2)	# 863
	add		x6, x6, x4	# 863
	lw		x7, -8(x2)	# 861
	ble		x7, x6, ble.13331	# 861
	lw		x27, -4(x2)	# 862
	sw		x6, -28(x2)	# 862
	addi	x4, x6, 0
	sw		x1, -32(x2)	# 862
...
solver_rect_surface.2684:
	...
	flw		f4, 0(x11)	# 928
	feq		x31, f4, f3	# 1
	beq		x31, x0, feq_else.13345	# 1
	addi	x11, x0, 1	# 1
	jal		x0, feq_cont.13344	# 1
feq_else.13345:
	addi	x11, x0, 0	# 1
feq_cont.13344:
	beq		x11, x10, beq.13346	# 928
	addi	x4, x0, 0	# 928
	jalr	x0, x1, 0	# 928
beq.13346:
	lw		x11, 16(x4)	# 421
	lw		x4, 24(x4)	# 373
	fle		x31, f3, f4	# 3
	beq		x31, x0, fle_else.13348	# 3
	addi	x12, x0, 0	# 3
	jal		x0, fle_cont.13347	# 3
fle_else.13348:
	addi	x12, x0, 1	# 3
fle_cont.13347:
	beq		x4, x10, beq.13350	# 204
	beq		x12, x10, beq.13352	# 204
	addi	x4, x0, 0	# 204
	jal		x0, beq_cont.13351	# 204
beq.13352:
	addi	x4, x0, 1	# 204
beq_cont.13351:
	jal		x0, beq_cont.13349	# 204
beq.13350:
	addi	x4, x12, 0	# 204
beq_cont.13349:
	addi	x12, x0, 4	# 930
	...
	add		x6, x11, x6	# 930
	flw		f5, 0(x6)	# 930
	beq		x4, x10, beq.13354	# 219
	jal		x0, beq_cont.13353	# 219
beq.13354:
	fsub	x31, x31, x31	# 4
	fsub	f5, x31, f5	# 4
beq_cont.13353:
...
fle_cont.13355:
	...
	flw		f4, 0(x4)	# 933
	fle		x31, f4, f1	# 6
	beq		x31, x0, fle_else.13357	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13356	# 6
fle_else.13357:
	addi	x4, x0, 1	# 6
fle_cont.13356:
	beq		x4, x10, beq.13358	# 933
	addi	x4, x0, 4	# 934
	mul		x4, x8, x4	# 934
	add		x4, x5, x4	# 934
	flw		f1, 0(x4)	# 934
...
fle_cont.13359:
	...
	flw		f2, 0(x4)	# 934
	fle		x31, f2, f1	# 6
	beq		x31, x0, fle_else.13361	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13360	# 6
fle_else.13361:
	addi	x4, x0, 1	# 6
fle_cont.13360:
	beq		x4, x10, beq.13362	# 934
	addi	x4, x0, 4	# 935
	mul		x4, x10, x4	# 935
	add		x4, x9, x4	# 935
	fsw		f0, 0(x4)	# 935
...
solver_surface.2699:
	...
	flw		f1, -48(x2)	# 2
	fle		x31, f0, f1	# 2
	beq		x31, x0, fle_else.13369	# 2
	addi	x4, x0, 0	# 2
	jal		x0, fle_cont.13368	# 2
fle_else.13369:
	addi	x4, x0, 1	# 2
fle_cont.13368:
	lw		x5, -40(x2)	# 956
	beq		x4, x5, beq.13370	# 956
	flw		f1, -24(x2)	# 957
	flw		f2, -16(x2)	# 957
	flw		f3, -8(x2)	# 957
	lw		x4, -32(x2)	# 957
...
solver_second.2718:
	...
	flw		f1, -64(x2)	# 1
	feq		x31, f0, f1	# 1
	beq		x31, x0, feq_else.13375	# 1
	addi	x4, x0, 1	# 1
	jal		x0, feq_cont.13374	# 1
feq_else.13375:
	addi	x4, x0, 0	# 1
feq_cont.13374:
	lw		x5, -60(x2)	# 1008
	beq		x4, x5, beq.13376	# 1008
	addi	x4, x0, 0	# 1009
	jalr	x0, x1, 0	# 1009
beq.13376:
	addi	x4, x0, 4	# 1013
	...
	lw		x5, 4(x4)	# 353
	lw		x6, -4(x2)	# 1016
	beq		x5, x6, beq.13378	# 1016
	jal		x0, beq_cont.13377	# 1016
beq.13378:
...
beq_cont.13377:
	...
	flw		f2, -64(x2)	# 2
	fle		x31, f0, f2	# 2
	beq		x31, x0, fle_else.13380	# 2
	addi	x5, x0, 0	# 2
	jal		x0, fle_cont.13379	# 2
fle_else.13380:
	addi	x5, x0, 1	# 2
fle_cont.13379:
	lw		x6, -60(x2)	# 1020
	beq		x5, x6, beq.13381	# 1020
	sw		x1, -88(x2)	# 1021
	addi	x2, x2, -92	# 1021
	...
	lw		x4, 24(x4)	# 373
	lw		x5, -60(x2)	# 1022
	beq		x4, x5, beq.13383	# 1022
	jal		x0, beq_cont.13382	# 1022
beq.13383:
	fsub	x31, x31, x31	# 4
	fsub	f0, x31, f0	# 4
beq_cont.13382:
...
solver.2724:
	...
	fsub	f2, f2, f3	# 1036
	lw		x6, 4(x4)	# 353
	beq		x6, x13, beq.13384	# 1039
	beq		x6, x11, beq.13385	# 1040
	addi	x27, x8, 0
	lw		x31, 0(x27)	# 1041
	jalr	x0, x31, 0	# 1041
beq.13385:
...
fle_cont.13386:
	...
	flw		f8, 0(x13)	# 406
	fle		x31, f8, f7	# 6
	beq		x31, x0, fle_else.13388	# 6
	addi	x13, x0, 0	# 6
	jal		x0, fle_cont.13387	# 6
fle_else.13388:
	addi	x13, x0, 1	# 6
fle_cont.13387:
	beq		x13, x11, beq.13390	# 1066
	addi	x13, x0, 4	# 1067
	mul		x13, x9, x13	# 1067
	add		x13, x5, x13	# 1067
	flw		f7, 0(x13)	# 1067
...
fle_else.13393:
	addi	x13, x0, 1	# 6
fle_cont.13392:
	beq		x13, x11, beq.13395	# 1067
	feq		x31, f5, f3	# 1
	beq		x31, x0, feq_else.13397	# 1
	addi	x13, x0, 1	# 1
	jal		x0, feq_cont.13396	# 1
feq_else.13397:
	addi	x13, x0, 0	# 1
feq_cont.13396:
	beq		x13, x11, beq.13399	# 1068
	addi	x13, x0, 0	# 1068
	jal		x0, beq_cont.13398	# 1068
beq.13399:
	addi	x13, x0, 1	# 1068
beq_cont.13398:
	jal		x0, beq_cont.13394	# 1067
beq.13395:
	addi	x13, x0, 0	# 1069
beq_cont.13394:
	jal		x0, beq_cont.13389	# 1066
beq.13390:
	addi	x13, x0, 0	# 1070
beq_cont.13389:
	beq		x13, x11, beq.13400	# 1065
	addi	x4, x0, 4	# 1072
	mul		x4, x11, x4	# 1072
	add		x4, x7, x4	# 1072
	fsw		f4, 0(x4)	# 1072
...
fle_cont.13401:
	...
	flw		f9, 0(x10)	# 396
	fle		x31, f9, f8	# 6
	beq		x31, x0, fle_else.13403	# 6
	addi	x10, x0, 0	# 6
	jal		x0, fle_cont.13402	# 6
fle_else.13403:
	addi	x10, x0, 1	# 6
fle_cont.13402:
	beq		x10, x11, beq.13405	# 1075
	addi	x10, x0, 4	# 1076
	mul		x10, x9, x10	# 1076
	add		x5, x5, x10	# 1076
	flw		f8, 0(x5)	# 1076
...
fle_cont.13406:
	...
	flw		f9, 0(x5)	# 416
	fle		x31, f9, f8	# 6
	beq		x31, x0, fle_else.13408	# 6
	addi	x5, x0, 0	# 6
	jal		x0, fle_cont.13407	# 6
fle_else.13408:
	addi	x5, x0, 1	# 6
fle_cont.13407:
	beq		x5, x11, beq.13410	# 1076
	feq		x31, f5, f3	# 1
	beq		x31, x0, feq_else.13412	# 1
	addi	x5, x0, 1	# 1
	jal		x0, feq_cont.13411	# 1
feq_else.13412:
	addi	x5, x0, 0	# 1
feq_cont.13411:
	beq		x5, x11, beq.13414	# 1077
	addi	x5, x0, 0	# 1077
	jal		x0, beq_cont.13413	# 1077
beq.13414:
	addi	x5, x0, 1	# 1077
beq_cont.13413:
	jal		x0, beq_cont.13409	# 1076
beq.13410:
	addi	x5, x0, 0	# 1078
beq_cont.13409:
	jal		x0, beq_cont.13404	# 1075
beq.13405:
	addi	x5, x0, 0	# 1079
beq_cont.13404:
	beq		x5, x11, beq.13415	# 1074
	addi	x4, x0, 4	# 1081
	mul		x4, x11, x4	# 1081
	add		x4, x7, x4	# 1081
	fsw		f4, 0(x4)	# 1081
...
fle_cont.13416:
	...
	flw		f5, 0(x5)	# 396
	fle		x31, f5, f0	# 6
	beq		x31, x0, fle_else.13418	# 6
	addi	x5, x0, 0	# 6
	jal		x0, fle_cont.13417	# 6
fle_else.13418:
	addi	x5, x0, 1	# 6
fle_cont.13417:
	beq		x5, x11, beq.13420	# 1084
	fmul	f0, f2, f6	# 1085
	fadd	f0, f0, f1	# 1085
	fle		x31, f0, f3	# 5
	beq		x31, x0, fle_cont.13421	# 5
	fsub	x31, x31, x31	# 5
	fsub	f0, x31, f0	# 5
fle_cont.13421:
	lw		x4, 16(x4)	# 401
	...
	flw		f1, 0(x4)	# 406
	fle		x31, f1, f0	# 6
	beq		x31, x0, fle_else.13423	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13422	# 6
fle_else.13423:
	addi	x4, x0, 1	# 6
fle_cont.13422:
	beq		x4, x11, beq.13425	# 1085
	feq		x31, f4, f3	# 1
...
feq_else.13427:
	addi	x4, x0, 0	# 1
feq_cont.13426:
	beq		x4, x11, beq.13429	# 1086
	addi	x4, x0, 0	# 1086
	jal		x0, beq_cont.13428	# 1086
beq.13429:
	addi	x4, x0, 1	# 1086
beq_cont.13428:
	jal		x0, beq_cont.13424	# 1085
beq.13425:
	addi	x4, x0, 0	# 1087
beq_cont.13424:
	jal		x0, beq_cont.13419	# 1084
beq.13420:
	addi	x4, x0, 0	# 1088
beq_cont.13419:
	beq		x4, x11, beq.13430	# 1083
	addi	x4, x0, 4	# 1090
	mul		x4, x11, x4	# 1090
	add		x4, x7, x4	# 1090
	fsw		f2, 0(x4)	# 1090
...
solver_surface_fast.2735:
	...
	flw		f4, 0(x10)	# 1097
	fle		x31, f3, f4	# 3
	beq		x31, x0, fle_else.13432	# 3
	addi	x10, x0, 0	# 3
	jal		x0, fle_cont.13431	# 3
fle_else.13432:
	addi	x10, x0, 1	# 3
fle_cont.13431:
	beq		x10, x8, beq.13433	# 1097
	addi	x10, x0, 4	# 1099
	mul		x9, x9, x10	# 1099
	add		x9, x5, x9	# 1099
	flw		f3, 0(x9)	# 1099
...
solver_second_fast.2741:
	...
	flw		f4, 0(x12)	# 1107
	feq		x31, f4, f3	# 1
	beq		x31, x0, feq_else.13435	# 1
	addi	x12, x0, 1	# 1
	jal		x0, feq_cont.13434	# 1
feq_else.13435:
	addi	x12, x0, 0	# 1
feq_cont.13434:
	beq		x12, x10, beq.13436	# 1108
	addi	x4, x0, 0	# 1109
	jalr	x0, x1, 0	# 1109
beq.13436:
	addi	x12, x0, 4	# 1111
	...
	lw		x5, 4(x4)	# 353
	lw		x6, -40(x2)	# 1113
	beq		x5, x6, beq.13439	# 1113
	jal		x0, beq_cont.13438	# 1113
beq.13439:
...
beq_cont.13438:
	...
	flw		f2, -16(x2)	# 2
	fle		x31, f0, f2	# 2
	beq		x31, x0, fle_else.13441	# 2
	addi	x5, x0, 0	# 2
	jal		x0, fle_cont.13440	# 2
fle_else.13441:
	addi	x5, x0, 1	# 2
fle_cont.13440:
	lw		x6, -8(x2)	# 1115
	beq		x5, x6, beq.13442	# 1115
	lw		x4, 24(x4)	# 373
	beq		x4, x6, beq.13444	# 1116
	addi	x4, x0, 0	# 1117
	sw		x4, -48(x2)	# 1117
	sw		x1, -52(x2)	# 1117
	addi	x2, x2, -56	# 1117
...
solver_fast.2747:
	...
	lw		x6, 0(x4)	# 1131
	lw		x4, 4(x10)	# 353
	beq		x4, x13, beq.13445	# 1133
	beq		x4, x11, beq.13446	# 1135
	addi	x5, x6, 0
	addi	x4, x10, 0
	addi	x27, x8, 0
	lw		x31, 0(x27)	# 1138
...
solver_surface_fast2.2751:
	...
	flw		f1, 0(x5)	# 1146
	fle		x31, f0, f1	# 3
	beq		x31, x0, fle_else.13448	# 3
	addi	x5, x0, 0	# 3
	jal		x0, fle_cont.13447	# 3
fle_else.13448:
	addi	x5, x0, 1	# 3
fle_cont.13447:
	beq		x5, x8, beq.13449	# 1146
	addi	x5, x0, 4	# 1147
	mul		x5, x7, x5	# 1147
	add		x5, x6, x5	# 1147
	flw		f0, 0(x5)	# 1147
...
beq.13452:
	...
	fsub	f1, f2, f1	# 1161
	fle		x31, f1, f3	# 2
	beq		x31, x0, fle_else.13454	# 2
	addi	x6, x0, 0	# 2
	jal		x0, fle_cont.13453	# 2
fle_else.13454:
	addi	x6, x0, 1	# 2
fle_cont.13453:
	beq		x6, x10, beq.13455	# 1162
	lw		x4, 24(x4)	# 373
	beq		x4, x10, beq.13457	# 1163
	addi	x4, x0, 0	# 1164
	sw		x7, 0(x2)	# 1164
	sw		x4, -4(x2)	# 1164
	sw		x5, -8(x2)	# 1164
...
solver_fast2.2765:
	...
	lw		x4, 0(x4)	# 1179
	lw		x11, 4(x9)	# 353
	beq		x11, x12, beq.13459	# 1181
	beq		x11, x10, beq.13460	# 1183
	addi	x6, x13, 0
	addi	x5, x4, 0
	addi	x27, x7, 0
	addi	x4, x9, 0
...
fle_cont.13478:
	addi	x11, x0, 0	# 204
	beq		x9, x11, beq.13481	# 204
	beq		x10, x11, beq.13483	# 204
	addi	x9, x0, 0	# 204
...
beq_cont.13476:
	...
	flw		f0, 0(x5)	# 1211
	feq		x31, f0, f1	# 1
	beq		x31, x0, feq_else.13487	# 1
	addi	x5, x0, 1	# 1
	jal		x0, feq_cont.13486	# 1
feq_else.13487:
	addi	x5, x0, 0	# 1
feq_cont.13486:
	beq		x5, x6, beq.13489	# 1211
	addi	x5, x0, 5	# 1212
...
beq.13489:
	...
	flw		f1, 0(x9)	# 3
	fle		x31, f1, f0	# 3
	beq		x31, x0, fle_else.13491	# 3
	addi	x9, x0, 0	# 3
	jal		x0, fle_cont.13490	# 3
fle_else.13491:
	addi	x9, x0, 1	# 3
fle_cont.13490:
	addi	x10, x0, 0	# 204
	beq		x8, x10, beq.13493	# 204
	beq		x9, x10, beq.13495	# 204
	addi	x8, x0, 0	# 204
	jal		x0, beq_cont.13494	# 204
beq.13495:
	addi	x8, x0, 1	# 204
beq_cont.13494:
...
beq_cont.13492:
	...
	flw		f0, 0(x6)	# 416
	addi	x6, x0, 0	# 219
	beq		x8, x6, beq.13497	# 219
	jal		x0, beq_cont.13496	# 219
beq.13497:
	fsub	x31, x31, x31	# 4
	fsub	f0, x31, f0	# 4
beq_cont.13496:
...
setup_surface_table.2771:
	...
	flw		f1, 0(x2)	# 2
	fle		x31, f0, f1	# 2
	beq		x31, x0, fle_else.13499	# 2
	addi	x7, x0, 0	# 2
	jal		x0, fle_cont.13498	# 2
fle_else.13499:
	addi	x7, x0, 1	# 2
fle_cont.13498:
	beq		x7, x6, beq.13501	# 1226
	addi	x6, x0, 0	# 1228
...
beq_cont.13502:
	flw		f1, 0(x2)	# 1
	feq		x31, f0, f1	# 1
	beq		x31, x0, feq_else.13505	# 1
	addi	x4, x0, 1	# 1
	jal		x0, feq_cont.13504	# 1
feq_else.13505:
	addi	x4, x0, 0	# 1
feq_cont.13504:
	beq		x4, x5, beq.13507	# 1261
	jal		x0, beq_cont.13506	# 1261
beq.13507:
	addi	x4, x0, 4	# 1262
...
ble.13508:
	...
	sw		x27, -4(x2)	# 1275
	sw		x11, -8(x2)	# 1275
	beq		x13, x11, beq.13511	# 1275
	addi	x8, x0, 2	# 1277
	beq		x13, x8, beq.13513	# 1277
	sw		x10, -12(x2)	# 1280
	sw		x5, -16(x2)	# 1280
	addi	x5, x9, 0
	addi	x4, x12, 0
...
ble.13514:
	...
	sw		x11, -8(x2)	# 1302
	sw		x5, -12(x2)	# 1302
	beq		x13, x9, beq.13517	# 1302
	addi	x6, x0, 2	# 1305
	ble		x13, x6, ble_cont.13518	# 1305
	addi	x6, x0, 0	# 1306
	addi	x9, x0, 4	# 1306
	mul		x6, x6, x9	# 1306
	add		x6, x12, x6	# 1306
	...
	addi	x5, x0, 3	# 1307
	lw		x6, -20(x2)	# 1307
	beq		x6, x5, beq.13520	# 1307
	jal		x0, beq_cont.13519	# 1307
beq.13520:
...
fle_else.13523:
	addi	x8, x0, 1	# 6
fle_cont.13522:
	beq		x8, x6, beq.13525	# 1327
	fle		x31, f1, f3	# 5
	beq		x31, x0, fle_else.13527	# 5
	fsub	f0, f0, f0	# 5
	fsub	f0, f0, f1	# 5
	jal		x0, fle_cont.13526	# 5
fle_else.13527:
	fsub	f0, f0, f0	# 5
	fadd	f0, f0, f1	# 5
fle_cont.13526:
	...
	flw		f1, 0(x7)	# 406
	fle		x31, f1, f0	# 6
	beq		x31, x0, fle_else.13529	# 6
	addi	x7, x0, 0	# 6
	jal		x0, fle_cont.13528	# 6
fle_else.13529:
	addi	x7, x0, 1	# 6
fle_cont.13528:
	beq		x7, x6, beq.13531	# 1328
	fle		x31, f2, f3	# 5
...
fle_else.13535:
	addi	x5, x0, 1	# 6
fle_cont.13534:
	jal		x0, beq_cont.13530	# 1328
beq.13531:
	addi	x5, x0, 0	# 1330
beq_cont.13530:
	jal		x0, beq_cont.13524	# 1327
beq.13525:
	addi	x5, x0, 0	# 1331
beq_cont.13524:
	beq		x5, x6, beq.13536	# 1326
	lw		x4, 24(x4)	# 373
	jalr	x0, x1, 0	# 377
beq.13536:
	lw		x4, 24(x4)	# 373
	beq		x4, x6, beq.13537	# 1332
	addi	x4, x0, 0	# 1332
	jalr	x0, x1, 0	# 1332
beq.13537:
	addi	x4, x0, 1	# 1332
...
is_plane_outside.2792:
	...
	flw		f1, -8(x2)	# 3
	fle		x31, f1, f0	# 3
	beq		x31, x0, fle_else.13540	# 3
	addi	x5, x0, 0	# 3
	jal		x0, fle_cont.13539	# 3
fle_else.13540:
	addi	x5, x0, 1	# 3
fle_cont.13539:
	lw		x6, 0(x2)	# 204
	beq		x4, x6, beq.13542	# 204
	beq		x5, x6, beq.13544	# 204
	addi	x4, x0, 0	# 204
	jal		x0, beq_cont.13543	# 204
beq.13544:
	addi	x4, x0, 1	# 204
beq_cont.13543:
	jal		x0, beq_cont.13541	# 204
beq.13542:
	addi	x4, x5, 0	# 204
beq_cont.13541:
	beq		x4, x6, beq.13545	# 1338
	addi	x4, x0, 0	# 1338
	jalr	x0, x1, 0	# 1338
beq.13545:
	addi	x4, x0, 1	# 1338
...
is_second_outside.2797:
	...
	lw		x5, 4(x4)	# 353
	lw		x6, -16(x2)	# 1344
	beq		x5, x6, beq.13548	# 1344
	jal		x0, beq_cont.13547	# 1344
beq.13548:
...
beq_cont.13547:
	...
	flw		f1, -8(x2)	# 3
	fle		x31, f1, f0	# 3
	beq		x31, x0, fle_else.13550	# 3
	addi	x5, x0, 0	# 3
	jal		x0, fle_cont.13549	# 3
fle_else.13550:
	addi	x5, x0, 1	# 3
fle_cont.13549:
	lw		x6, 0(x2)	# 204
	beq		x4, x6, beq.13552	# 204
	beq		x5, x6, beq.13554	# 204
	addi	x4, x0, 0	# 204
	jal		x0, beq_cont.13553	# 204
beq.13554:
	addi	x4, x0, 1	# 204
beq_cont.13553:
	jal		x0, beq_cont.13551	# 204
beq.13552:
	addi	x4, x5, 0	# 204
beq_cont.13551:
	beq		x4, x6, beq.13555	# 1345
	addi	x4, x0, 0	# 1345
	jalr	x0, x1, 0	# 1345
beq.13555:
	addi	x4, x0, 1	# 1345
...
is_outside.2802:
	...
	fsub	f2, f2, f3	# 1352
	lw		x9, 4(x4)	# 353
	beq		x9, x10, beq.13556	# 1354
	beq		x9, x8, beq.13557	# 1356
	addi	x27, x5, 0
	lw		x31, 0(x27)	# 1359
	jalr	x0, x31, 0	# 1359
beq.13557:
...
shadow_check_and_group.2813:
	...
	add		x5, x7, x5	# 1389
	flw		f0, 0(x5)	# 1389
	beq		x4, x6, beq.13562	# 1390
	lui		x4, %hi(l.9220)	# 1390
	ori		x4, x0, %lo(l.9220)	# 1390
	flw		f1, 0(x4)	# 1390
	fle		x31, f1, f0	# 6
	beq		x31, x0, fle_else.13564	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13563	# 6
fle_else.13564:
	addi	x4, x0, 1	# 6
fle_cont.13563:
	jal		x0, beq_cont.13561	# 1390
beq.13562:
	addi	x4, x0, 0	# 1390
beq_cont.13561:
	beq		x4, x6, beq.13565	# 1390
...
fle_cont.13575:
	...
	lw		x1, -32(x2)	# 1443
	addi	x5, x0, 0	# 1443
	beq		x4, x5, beq.13580	# 1443
	addi	x4, x0, 1	# 1444
	jal		x0, beq_cont.13579	# 1443
beq.13580:
	addi	x4, x0, 0	# 1445
beq_cont.13579:
	jal		x0, beq_cont.13577	# 1442
beq.13578:
	addi	x4, x0, 0	# 1446
beq_cont.13577:
	jal		x0, beq_cont.13573	# 1441
beq.13574:
	addi	x4, x0, 0	# 1447
beq_cont.13573:
	jal		x0, beq_cont.13571	# 1435
beq.13572:
	addi	x4, x0, 1	# 1436
beq_cont.13571:
	lw		x5, -24(x2)	# 1434
	beq		x4, x5, beq.13581	# 1434
	lw		x4, -16(x2)	# 1449
	lw		x6, 0(x2)	# 1449
	lw		x27, -4(x2)	# 1449
	addi	x5, x6, 0
...
solve_each_element.2822:
	...
	flw		f1, -32(x2)	# 6
	fle		x31, f0, f1	# 6
	beq		x31, x0, fle_else.13587	# 6
	addi	x6, x0, 0	# 6
	jal		x0, fle_cont.13586	# 6
fle_else.13587:
	addi	x6, x0, 1	# 6
fle_cont.13586:
	beq		x6, x5, beq_cont.13588	# 1475
	addi	x6, x0, 0	# 1476
	addi	x7, x0, 4	# 1476
	mul		x6, x6, x7	# 1476
	lw		x7, -24(x2)	# 1476
	...
	flw		f1, 0(x6)	# 1476
	fle		x31, f1, f0	# 6
	beq		x31, x0, fle_else.13590	# 6
	addi	x6, x0, 0	# 6
	jal		x0, fle_cont.13589	# 6
fle_else.13590:
	addi	x6, x0, 1	# 6
fle_cont.13589:
	addi	x8, x0, 0	# 1476
	beq		x6, x8, beq_cont.13591	# 1476
...
judge_intersection.2834:
	...
	flw		f1, 0(x4)	# 1547
	fle		x31, f0, f1	# 6
	beq		x31, x0, fle_else.13607	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13606	# 6
fle_else.13607:
	addi	x4, x0, 1	# 6
fle_cont.13606:
	beq		x4, x5, beq.13608	# 1547
	lui		x4, %hi(l.9339)	# 1548
	ori		x4, x0, %lo(l.9339)	# 1548
	flw		f1, 0(x4)	# 1548
	fle		x31, f1, f0	# 6
	beq		x31, x0, fle_else.13609	# 6
	addi	x4, x0, 0	# 6
	jalr	x0, x1, 0	# 6
fle_else.13609:
	addi	x4, x0, 1	# 6
...
solve_each_element_fast.2836:
	...
	flw		f1, -32(x2)	# 6
	fle		x31, f0, f1	# 6
	beq		x31, x0, fle_else.13613	# 6
	addi	x6, x0, 0	# 6
	jal		x0, fle_cont.13612	# 6
fle_else.13613:
	addi	x6, x0, 1	# 6
fle_cont.13612:
	beq		x6, x5, beq_cont.13614	# 1569
	addi	x6, x0, 0	# 1570
	addi	x7, x0, 4	# 1570
	mul		x6, x6, x7	# 1570
	lw		x7, -28(x2)	# 1570
	...
	flw		f1, 0(x6)	# 1570
	fle		x31, f1, f0	# 6
	beq		x31, x0, fle_else.13616	# 6
	addi	x6, x0, 0	# 6
	jal		x0, fle_cont.13615	# 6
fle_else.13616:
	addi	x6, x0, 1	# 6
fle_cont.13615:
	addi	x8, x0, 0	# 1570
	beq		x6, x8, beq_cont.13617	# 1570
...
utexture.2859:
	...
	add		x15, x6, x15	# 1712
	fsw		f2, 0(x15)	# 1712
	beq		x14, x13, beq.13640	# 1713
	beq		x14, x10, beq.13641	# 1731
	beq		x14, x11, beq.13642	# 1738
	addi	x7, x0, 4	# 1749
	beq		x14, x7, beq.13643	# 1749
	jalr	x0, x1, 0	# 1777
beq.13643:
	addi	x7, x0, 4	# 1751
	mul		x7, x12, x7	# 1751
	...
	flw		f3, -32(x2)	# 5
	fle		x31, f1, f3	# 5
	beq		x31, x0, fle_else.13649	# 5
	fsub	f4, f4, f4	# 5
	fsub	f4, f4, f1	# 5
	jal		x0, fle_cont.13648	# 5
fle_else.13649:
	fsub	f4, f4, f4	# 5
	fadd	f4, f4, f1	# 5
fle_cont.13648:
...
fle_cont.13650:
	...
	fsw		f5, -80(x2)	# 1755
	fsw		f2, -88(x2)	# 1755
	beq		x4, x5, beq.13653	# 1755
	lui		x4, %hi(l.9559)	# 1756
	ori		x4, x0, %lo(l.9559)	# 1756
	flw		f0, 0(x4)	# 1756
	jal		x0, beq_cont.13652	# 1755
beq.13653:
	fdiv	f0, f0, f1	# 1758
	lui		x4, %hi(l.8174)	# 5
...
beq_cont.13652:
	...
	flw		f2, -88(x2)	# 5
	fle		x31, f2, f1	# 5
	beq		x31, x0, fle_else.13656	# 5
	fsub	f3, f3, f3	# 5
	fsub	f3, f3, f2	# 5
	jal		x0, fle_cont.13655	# 5
fle_else.13656:
	fsub	f3, f3, f3	# 5
	fadd	f3, f3, f2	# 5
fle_cont.13655:
	flw		f4, -80(x2)	# 6
	fle		x31, f4, f3	# 6
	beq		x31, x0, fle_else.13658	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13657	# 6
fle_else.13658:
	addi	x4, x0, 1	# 6
fle_cont.13657:
	lw		x5, -24(x2)	# 1766
	beq		x4, x5, beq.13660	# 1766
	lui		x4, %hi(l.9559)	# 1767
	ori		x4, x0, %lo(l.9559)	# 1767
	flw		f0, 0(x4)	# 1767
	jal		x0, beq_cont.13659	# 1766
beq.13660:
	fdiv	f0, f0, f2	# 1769
	lui		x4, %hi(l.8174)	# 5
	ori		x4, x0, %lo(l.8174)	# 5
...
beq.13640:
	...
	flw		f2, 0(x4)	# 1719
	fle		x31, f2, f0	# 6
	beq		x31, x0, fle_else.13670	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13669	# 6
fle_else.13670:
	addi	x4, x0, 1	# 6
fle_cont.13669:
	addi	x5, x0, 4	# 1721
...
fle_cont.13672:
	lw		x5, -24(x2)	# 1727
	lw		x6, -160(x2)	# 1727
	beq		x6, x5, beq.13675	# 1727
	beq		x4, x5, beq.13677	# 1728
	flw		f0, -8(x2)	# 1728
	jal		x0, beq_cont.13676	# 1728
beq.13677:
	flw		f0, -32(x2)	# 1728
beq_cont.13676:
	jal		x0, beq_cont.13674	# 1727
beq.13675:
	beq		x4, x5, beq.13679	# 1729
	flw		f0, -32(x2)	# 1729
	jal		x0, beq_cont.13678	# 1729
beq.13679:
	flw		f0, -8(x2)	# 1729
beq_cont.13678:
beq_cont.13674:
...
add_light.2862:
	...
	flw		f3, 4(x27)	# 2
	fle		x31, f0, f3	# 2
	beq		x31, x0, fle_else.13682	# 2
	addi	x10, x0, 0	# 2
	jal		x0, fle_cont.13681	# 2
fle_else.13682:
	addi	x10, x0, 1	# 2
fle_cont.13681:
	sw		x7, 0(x2)	# 1788
	...
	fsw		f3, -32(x2)	# 1788
	fsw		f1, -40(x2)	# 1788
	beq		x10, x8, beq_cont.13685	# 1788
	addi	x27, x4, 0
	addi	x4, x6, 0
	sw		x1, -48(x2)	# 1789
	addi	x2, x2, -52	# 1789
...
beq_cont.13685:
	...
	flw		f1, -40(x2)	# 2
	fle		x31, f1, f0	# 2
	beq		x31, x0, fle_else.13687	# 2
	addi	x4, x0, 0	# 2
	jal		x0, fle_cont.13686	# 2
fle_else.13687:
	addi	x4, x0, 1	# 2
fle_cont.13686:
	lw		x5, -24(x2)	# 1793
	beq		x4, x5, beq.13688	# 1793
	fmul	f0, f1, f1	# 8
	fmul	f0, f0, f0	# 8
	flw		f1, -16(x2)	# 1794
	fmul	f0, f0, f1	# 1794
...
ble.13691:
	...
	lw		x5, -60(x2)	# 655
	lw		x6, 0(x5)	# 655
	beq		x4, x6, beq.13696	# 1811
	jal		x0, beq_cont.13695	# 1811
beq.13696:
	addi	x4, x0, 0	# 1813
	addi	x6, x0, 0	# 1813
	addi	x7, x0, 4	# 1813
	...
	lw		x1, -76(x2)	# 1813
	addi	x5, x0, 0	# 1813
	beq		x4, x5, beq.13698	# 1813
	jal		x0, beq_cont.13697	# 1813
beq.13698:
	lw		x4, -48(x2)	# 639
	lw		x5, 0(x4)	# 639
	lw		x6, -40(x2)	# 1815
...
ble.13700:
	...
	sw		x4, -192(x2)	# 1693
	sw		x6, -196(x2)	# 1693
	beq		x8, x9, beq.13706	# 1693
	lw		x10, -116(x2)	# 1695
	beq		x8, x10, beq.13708	# 1695
	lw		x27, -96(x2)	# 1698
	addi	x4, x6, 0
	sw		x1, -200(x2)	# 1698
	addi	x2, x2, -204	# 1698
...
beq_cont.13705:
	...
	flw		f1, 0(x7)	# 1852
	fle		x31, f1, f0	# 6
	beq		x31, x0, fle_else.13710	# 6
	addi	x7, x0, 0	# 6
	jal		x0, fle_cont.13709	# 6
fle_else.13710:
	addi	x7, x0, 1	# 6
fle_cont.13709:
	beq		x7, x9, beq.13712	# 1852
	addi	x7, x0, 0	# 1853
	addi	x8, x0, 4	# 1853
	lw		x10, -172(x2)	# 1853
	mul		x8, x10, x8	# 1853
...
beq_cont.13711:
	...
	lw		x1, -224(x2)	# 1870
	lw		x5, -176(x2)	# 1870
	beq		x4, x5, beq.13715	# 1870
	jal		x0, beq_cont.13714	# 1870
beq.13715:
	lw		x4, -40(x2)	# 1871
	lw		x6, -152(x2)	# 1871
	lw		x27, -160(x2)	# 1871
...
beq_cont.13714:
	...
	flw		f1, -136(x2)	# 6
	fle		x31, f1, f0	# 6
	beq		x31, x0, fle_else.13717	# 6
	addi	x4, x0, 0	# 6
	jal		x0, fle_cont.13716	# 6
fle_else.13717:
	addi	x4, x0, 1	# 6
fle_cont.13716:
	lw		x5, -176(x2)	# 1881
	beq		x4, x5, beq.13718	# 1881
	lw		x4, -172(x2)	# 1883
	lw		x6, -76(x2)	# 1883
	ble		x6, x4, ble_cont.13719	# 1883
	addi	x6, x4, 1	# 1884
	addi	x7, x0, -1	# 1884
	addi	x8, x0, 4	# 1884
	mul		x6, x6, x8	# 1884
...
beq.13704:
	...
	flw		f1, -144(x2)	# 2
	fle		x31, f0, f1	# 2
	beq		x31, x0, fle_else.13725	# 2
	addi	x4, x0, 0	# 2
	jal		x0, fle_cont.13724	# 2
fle_else.13725:
	addi	x4, x0, 1	# 2
fle_cont.13724:
	lw		x5, -176(x2)	# 1902
	beq		x4, x5, beq.13726	# 1902
	fmul	f1, f0, f0	# 8
	fmul	f0, f1, f0	# 1905
	flw		f1, -136(x2)	# 1905
	fmul	f0, f0, f1	# 1905
...
trace_diffuse_ray.2877:
	...
	lw		x8, -76(x2)	# 1693
	sw		x4, -96(x2)	# 1693
	beq		x7, x8, beq.13733	# 1693
	lw		x6, -68(x2)	# 1695
	beq		x7, x6, beq.13735	# 1695
	lw		x27, -60(x2)	# 1698
	sw		x1, -100(x2)	# 1698
	addi	x2, x2, -104	# 1698
	lw		x31, 0(x27)	# 1698
...
beq.13736:
	...
	flw		f1, -24(x2)	# 2
	fle		x31, f0, f1	# 2
	beq		x31, x0, fle_else.13739	# 2
	addi	x4, x0, 0	# 2
	jal		x0, fle_cont.13738	# 2
fle_else.13739:
	addi	x4, x0, 1	# 2
fle_cont.13738:
	lw		x5, -92(x2)	# 1935
	beq		x4, x5, beq.13741	# 1935
	jal		x0, beq_cont.13740	# 1935
beq.13741:
	fsub	f0, f0, f0	# 1935
	fadd	f0, f0, f1	# 1935
beq_cont.13740:
...
ble.13743:
	...
	flw		f1, -32(x2)	# 3
	fle		x31, f1, f0	# 3
	beq		x31, x0, fle_else.13746	# 3
	addi	x4, x0, 0	# 3
	jal		x0, fle_cont.13745	# 3
fle_else.13746:
	addi	x4, x0, 1	# 3
fle_cont.13745:
	lw		x5, -28(x2)	# 1949
	beq		x4, x5, beq.13748	# 1949
	lw		x4, -24(x2)	# 1950
	addi	x5, x4, 1	# 1950
	addi	x6, x0, 4	# 1950
	mul		x5, x5, x6	# 1950
...
trace_diffuse_ray_80percent.2889:
	...
	sw		x16, -44(x2)	# 1971
	sw		x4, -48(x2)	# 1971
	beq		x4, x15, beq_cont.13749	# 1971
	addi	x17, x0, 0	# 1972
	addi	x18, x0, 4	# 1972
...
neighbors_exist.2905:
	...
	lw		x9, 0(x9)	# 2050
	add		x10, x5, x8	# 2050
	ble		x9, x10, ble.13760	# 2050
	ble		x5, x7, ble.13761	# 2051
	addi	x5, x0, 4	# 2052
	mul		x5, x7, x5	# 2052
	add		x5, x6, x5	# 2052
	lw		x5, 0(x5)	# 2052
	add		x6, x4, x8	# 2052
	ble		x5, x6, ble.13762	# 2052
	ble		x4, x7, ble.13763	# 2053
	addi	x4, x0, 1	# 2054
	jalr	x0, x1, 0	# 2054
ble.13763:
	addi	x4, x0, 0	# 2055
...
write_rgb_element_int.2927:
	...
	lw		x1, -4(x2)	# 2128
	addi	x5, x0, 255	# 2129
	ble		x4, x5, ble.13775	# 2129
	addi	x4, x0, 255	# 2129
	jal		x0, ble_cont.13774	# 2129
ble.13775:
	lw		x5, 0(x2)	# 2129
	ble		x5, x4, ble_cont.13776	# 2129
	addi	x4, x0, 0	# 2129
ble_cont.13776:
ble_cont.13774:
...
write_rgb_element_char.2929:
	...
	lw		x1, -4(x2)	# 2134
	addi	x5, x0, 255	# 2135
	ble		x4, x5, ble.13778	# 2135
	addi	x4, x0, 255	# 2135
	jal		x0, ble_cont.13777	# 2135
ble.13778:
	lw		x5, 0(x2)	# 2135
	ble		x5, x4, ble_cont.13779	# 2135
	addi	x4, x0, 0	# 2135
ble_cont.13779:
ble_cont.13777:
...
ble.13783:
	...
	sw		x15, -8(x2)	# 2170
	sw		x5, -12(x2)	# 2170
	beq		x16, x14, beq_cont.13785	# 2170
	lw		x16, 24(x4)	# 614
	addi	x17, x0, 0	# 616
	addi	x18, x0, 4	# 616
	mul		x17, x17, x18	# 616
...
ble.13786:
	...
	add		x4, x6, x4	# 224
	lw		x6, -4(x2)	# 225
	ble		x6, x4, ble.13790	# 225
	addi	x6, x4, 0	# 225
	jal		x0, ble_cont.13789	# 225
ble.13790:
	sub		x6, x4, x6	# 225
ble_cont.13789:
	flw		f0, -88(x2)	# 2211
...
scan_line.2954:
	...
	sw		x15, -40(x2)	# 2257
	sw		x10, -44(x2)	# 2257
	ble		x12, x4, ble_cont.13797	# 2257
	addi	x12, x4, 1	# 2258
	addi	x6, x8, 0
	addi	x5, x12, 0
	addi	x4, x7, 0
...
ble_cont.13797:
	...
	add		x5, x6, x5	# 224
	lw		x6, -4(x2)	# 225
	ble		x6, x5, ble.13799	# 225
	addi	x8, x5, 0	# 225
	jal		x0, ble_cont.13798	# 225
ble.13799:
	sub		x8, x5, x6	# 225
ble_cont.13798:
	lw		x5, -28(x2)	# 2261
...
ble.13807:
	...
	add		x4, x6, x4	# 224
	lw		x6, -4(x2)	# 225
	ble		x6, x4, ble.13811	# 225
	jal		x0, ble_cont.13810	# 225
ble.13811:
	sub		x4, x4, x6	# 225
ble_cont.13810:
	flw		f0, -24(x2)	# 2363
...
ble.13812:
	...
	add		x5, x6, x5	# 224
	lw		x6, -4(x2)	# 225
	ble		x6, x5, ble.13815	# 225
	jal		x0, ble_cont.13814	# 225
ble.13815:
	sub		x5, x5, x6	# 225
ble_cont.13814:
	lw		x6, -20(x2)	# 2372
...
beq.13835:
	...
	flw		f1, 0(x11)	# 2473
	fle		x31, f1, f0	# 6
	beq		x31, x0, fle_else.13838	# 6
	addi	x11, x0, 0	# 6
	jal		x0, fle_cont.13837	# 6
fle_else.13838:
	addi	x11, x0, 1	# 6
fle_cont.13837:
	beq		x11, x9, beq.13839	# 2473
	lw		x9, 4(x7)	# 353
	beq		x9, x10, beq.13840	# 2476
	beq		x9, x8, beq.13841	# 2478
	jalr	x0, x1, 0	# 2480
beq.13841:
	addi	x27, x5, 0
	addi	x5, x7, 0
